...
64:                                               ; preds = %84, %61
  %.03 = phi i32 [ 0, %61 ], [ %fi85, %84 ], !taffo.info !109, !llfi_index !111
...
74:                                               ; preds = %72
  ...
  %fi84 = call i32 @injectFault2(i64 89, i32 %fi34, i32 33, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @store_namestr, i32 0, i32 0)), !llfi_injectfault !25
  store i32 %fi84, i32* %s3_29fixp11, align 4, !taffo.info !131, !llfi_index !141
  br label %84, !llfi_index !142

84:                                               ; preds = %74
  %fi86 = call i32 @injectFault2(i64 91, i32 %fi61, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi87 = call i32 @injectFault2(i64 91, i32 4, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %85 = add nsw i32 %fi86, %fi87, !taffo.info !143, !llfi_index !145, !taffo.constinfo !44
  %fi85 = call i32 @injectFault2(i64 91, i32 %85, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !58
...
88:                                               ; preds = %103, %87
  %.02 = phi i32 [ 0, %87 ], [ %fi128, %103 ], !taffo.info !109, !llfi_index !151
  %fi88 = call i32 @injectFault2(i64 95, i32 %.02, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %89 = load i32, i32* %3, align 4, !llfi_index !152
  %fi89 = call i32 @injectFault2(i64 96, i32 %89, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi91 = call i32 @injectFault2(i64 97, i32 %fi89, i32 17, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi92 = call i32 @injectFault2(i64 97, i32 2, i32 17, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %90 = mul nsw i32 %fi91, %fi92, !llfi_index !153, !taffo.constinfo !44
  %fi90 = call i32 @injectFault2(i64 97, i32 %90, i32 17, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi94 = call i32 @injectFault2(i64 98, i32 %fi90, i32 17, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi95 = call i32 @injectFault2(i64 98, i32 2, i32 17, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %91 = mul nsw i32 %fi94, %fi95, !llfi_index !154, !taffo.constinfo !44
  %fi93 = call i32 @injectFault2(i64 98, i32 %91, i32 17, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi97 = call i32 @injectFault2(i64 99, i32 %fi88, i32 53, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi98 = call i32 @injectFault2(i64 99, i32 %fi93, i32 53, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %92 = icmp slt i32 %fi97, %fi98, !taffo.info !115, !llfi_index !155
  %fi96 = call i1 @injectFault0(i64 99, i1 %92, i32 53, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi99 = call i1 @injectFault0(i64 100, i1 %fi96, i32 2, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @br_namestr, i32 0, i32 0)), !llfi_injectfault !25
  br i1 %fi99, label %93, label %105, !llfi_index !156

93:                                               ; preds = %88
  %fi101 = call i32 @injectFault2(i64 101, i32 %fi88, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi102 = call i32 @injectFault2(i64 101, i32 0, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %94 = add nsw i32 %fi101, %fi102, !taffo.info !127, !llfi_index !157, !taffo.constinfo !44
  %fi100 = call i32 @injectFault2(i64 101, i32 %94, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi104 = call i32 @injectFault2(i64 102, i32 %fi100, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %95 = sext i32 %fi104 to i64, !taffo.info !127, !llfi_index !158
  %fi103 = call i64 @injectFault1(i64 102, i64 %95, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi105 = call i64 @injectFault1(i64 103, i64 %fi103, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %s3_29fixp10 = getelementptr i32, i32* %s3_29fixp, i64 %fi105, !taffo.info !66, !llfi_index !159, !taffo.target !69
  %s3_29fixp18 = load i32, i32* %s3_29fixp10, align 4, !taffo.info !160, !llfi_index !162, !taffo.target !69
  %fi106 = call i32 @injectFault2(i64 104, i32 %s3_29fixp18, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi108 = call i32 @injectFault2(i64 105, i32 %fi88, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi109 = call i32 @injectFault2(i64 105, i32 1, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %96 = add nsw i32 %fi108, %fi109, !taffo.info !136, !llfi_index !163, !taffo.constinfo !44
  %fi107 = call i32 @injectFault2(i64 105, i32 %96, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi111 = call i32 @injectFault2(i64 106, i32 %fi107, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %97 = sext i32 %fi111 to i64, !taffo.info !136, !llfi_index !164
  %fi110 = call i64 @injectFault1(i64 106, i64 %97, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi112 = call i64 @injectFault1(i64 107, i64 %fi110, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %s3_29fixp9 = getelementptr i32, i32* %s3_29fixp, i64 %fi112, !taffo.info !66, !llfi_index !165, !taffo.target !69
  %s3_29fixp17 = load i32, i32* %s3_29fixp9, align 4, !taffo.info !160, !llfi_index !166, !taffo.target !69
  %fi113 = call i32 @injectFault2(i64 108, i32 %s3_29fixp17, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi115 = call i32 @injectFault2(i64 109, i32 %fi88, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi116 = call i32 @injectFault2(i64 109, i32 2, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %98 = add nsw i32 %fi115, %fi116, !taffo.info !167, !llfi_index !169, !taffo.constinfo !44
  %fi114 = call i32 @injectFault2(i64 109, i32 %98, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi118 = call i32 @injectFault2(i64 110, i32 %fi114, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %99 = sext i32 %fi118 to i64, !taffo.info !167, !llfi_index !170
  %fi117 = call i64 @injectFault1(i64 110, i64 %99, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi119 = call i64 @injectFault1(i64 111, i64 %fi117, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %s3_29fixp8 = getelementptr i32, i32* %s3_29fixp, i64 %fi119, !taffo.info !66, !llfi_index !171, !taffo.target !69
  %fi121 = call i32 @injectFault2(i64 112, i32 %fi88, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi122 = call i32 @injectFault2(i64 112, i32 3, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %100 = add nsw i32 %fi121, %fi122, !taffo.info !172, !llfi_index !174, !taffo.constinfo !44
  %fi120 = call i32 @injectFault2(i64 112, i32 %100, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi124 = call i32 @injectFault2(i64 113, i32 %fi120, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %101 = sext i32 %fi124 to i64, !taffo.info !172, !llfi_index !175
  %fi123 = call i64 @injectFault1(i64 113, i64 %101, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi125 = call i64 @injectFault1(i64 114, i64 %fi123, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %s3_29fixp7 = getelementptr i32, i32* %s3_29fixp, i64 %fi125, !taffo.info !66, !llfi_index !176, !taffo.target !69
  %fi126 = call i32 @injectFault2(i64 115, i32 %fi106, i32 5, i32 0, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @invoke_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi127 = call i32 @injectFault2(i64 115, i32 %fi113, i32 5, i32 1, i32 2, i32 2, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @invoke_namestr, i32 0, i32 0)), !llfi_injectfault !25
  invoke void @_Z10forwardk2jffPfS_.2_fixp(i32 %fi126, i32 %fi127, i32* %s3_29fixp8, i32* %s3_29fixp7)
...
103:                                              ; preds = %102
  %fi129 = call i32 @injectFault2(i64 117, i32 %fi88, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi130 = call i32 @injectFault2(i64 117, i32 4, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %104 = add nsw i32 %fi129, %fi130, !taffo.info !143, !llfi_index !180, !taffo.constinfo !44
  %fi128 = call i32 @injectFault2(i64 117, i32 %104, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !58
...
106:                                              ; preds = %122, %105
  %.01 = phi i32 [ 0, %105 ], [ %fi174, %122 ], !taffo.info !109, !llfi_index !184
  %fi131 = call i32 @injectFault2(i64 120, i32 %.01, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %107 = load i32, i32* %3, align 4, !llfi_index !185
  %fi132 = call i32 @injectFault2(i64 121, i32 %107, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi134 = call i32 @injectFault2(i64 122, i32 %fi132, i32 17, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi135 = call i32 @injectFault2(i64 122, i32 2, i32 17, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %108 = mul nsw i32 %fi134, %fi135, !llfi_index !186, !taffo.constinfo !44
  %fi133 = call i32 @injectFault2(i64 122, i32 %108, i32 17, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi137 = call i32 @injectFault2(i64 123, i32 %fi133, i32 17, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi138 = call i32 @injectFault2(i64 123, i32 2, i32 17, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %109 = mul nsw i32 %fi137, %fi138, !llfi_index !187, !taffo.constinfo !44
  %fi136 = call i32 @injectFault2(i64 123, i32 %109, i32 17, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi140 = call i32 @injectFault2(i64 124, i32 %fi131, i32 53, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi141 = call i32 @injectFault2(i64 124, i32 %fi136, i32 53, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %110 = icmp slt i32 %fi140, %fi141, !taffo.info !115, !llfi_index !188
  %fi139 = call i1 @injectFault0(i64 124, i1 %110, i32 53, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi142 = call i1 @injectFault0(i64 125, i1 %fi139, i32 2, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @br_namestr, i32 0, i32 0)), !llfi_injectfault !25
  br i1 %fi142, label %111, label %124, !llfi_index !189

111:                                              ; preds = %106
  %fi144 = call i32 @injectFault2(i64 126, i32 %fi131, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi145 = call i32 @injectFault2(i64 126, i32 2, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %112 = add nsw i32 %fi144, %fi145, !taffo.info !167, !llfi_index !190, !taffo.constinfo !44
  %fi143 = call i32 @injectFault2(i64 126, i32 %112, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi147 = call i32 @injectFault2(i64 127, i32 %fi143, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %113 = sext i32 %fi147 to i64, !taffo.info !167, !llfi_index !191
  %fi146 = call i64 @injectFault1(i64 127, i64 %113, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi148 = call i64 @injectFault1(i64 128, i64 %fi146, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %s3_29fixp6 = getelementptr i32, i32* %s3_29fixp, i64 %fi148, !taffo.info !66, !llfi_index !192, !taffo.target !69
  %s3_29fixp16 = load i32, i32* %s3_29fixp6, align 4, !taffo.info !193, !llfi_index !196, !taffo.target !69
  %fi149 = call i32 @injectFault2(i64 129, i32 %s3_29fixp16, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi151 = call i32 @injectFault2(i64 130, i32 %fi131, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi152 = call i32 @injectFault2(i64 130, i32 3, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %114 = add nsw i32 %fi151, %fi152, !taffo.info !172, !llfi_index !197, !taffo.constinfo !44
  %fi150 = call i32 @injectFault2(i64 130, i32 %114, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi154 = call i32 @injectFault2(i64 131, i32 %fi150, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %115 = sext i32 %fi154 to i64, !taffo.info !172, !llfi_index !198
  %fi153 = call i64 @injectFault1(i64 131, i64 %115, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi155 = call i64 @injectFault1(i64 132, i64 %fi153, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %s3_29fixp5 = getelementptr i32, i32* %s3_29fixp, i64 %fi155, !taffo.info !66, !llfi_index !199, !taffo.target !69
  %s3_29fixp15 = load i32, i32* %s3_29fixp5, align 4, !taffo.info !200, !llfi_index !201, !taffo.target !69
  %fi156 = call i32 @injectFault2(i64 133, i32 %s3_29fixp15, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi158 = call i32 @injectFault2(i64 134, i32 %fi131, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi159 = call i32 @injectFault2(i64 134, i32 0, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %116 = add nsw i32 %fi158, %fi159, !taffo.info !127, !llfi_index !202, !taffo.constinfo !44
  %fi157 = call i32 @injectFault2(i64 134, i32 %116, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi161 = call i32 @injectFault2(i64 135, i32 %fi157, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %117 = sext i32 %fi161 to i64, !taffo.info !127, !llfi_index !203
  %fi160 = call i64 @injectFault1(i64 135, i64 %117, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi162 = call i64 @injectFault1(i64 136, i64 %fi160, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %s3_29fixp4 = getelementptr i32, i32* %s3_29fixp, i64 %fi162, !taffo.info !66, !llfi_index !204, !taffo.target !69
  %fi164 = call i32 @injectFault2(i64 137, i32 %fi131, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi165 = call i32 @injectFault2(i64 137, i32 1, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %118 = add nsw i32 %fi164, %fi165, !taffo.info !136, !llfi_index !205, !taffo.constinfo !44
  %fi163 = call i32 @injectFault2(i64 137, i32 %118, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi167 = call i32 @injectFault2(i64 138, i32 %fi163, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %119 = sext i32 %fi167 to i64, !taffo.info !136, !llfi_index !206
  %fi166 = call i64 @injectFault1(i64 138, i64 %119, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi168 = call i64 @injectFault1(i64 139, i64 %fi166, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %s3_29fixp3 = getelementptr i32, i32* %s3_29fixp, i64 %fi168, !taffo.info !66, !llfi_index !207, !taffo.target !69
  %fi170 = call i32 @injectFault2(i64 140, i32 %fi149, i32 27, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi171 = call i32 @injectFault2(i64 140, i32 1, i32 27, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %120 = ashr i32 %fi170, %fi171, !taffo.info !193, !llfi_index !208, !taffo.target !69
  %fi169 = call i32 @injectFault2(i64 140, i32 %120, i32 27, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi172 = call i32 @injectFault2(i64 141, i32 %fi169, i32 5, i32 0, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @invoke_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi173 = call i32 @injectFault2(i64 141, i32 %fi156, i32 5, i32 1, i32 2, i32 2, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @invoke_namestr, i32 0, i32 0)), !llfi_injectfault !25
  invoke void @_Z10inversek2jffPfS_.1_fixp(i32 %fi172, i32 %fi173, i32* %s3_29fixp4, i32* %s3_29fixp3)
...
122:                                              ; preds = %121
  %fi175 = call i32 @injectFault2(i64 143, i32 %fi131, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi176 = call i32 @injectFault2(i64 143, i32 4, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %123 = add nsw i32 %fi175, %fi176, !taffo.info !143, !llfi_index !211, !taffo.constinfo !44
  %fi174 = call i32 @injectFault2(i64 143, i32 %123, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !58
...
128:                                              ; preds = %126
  %fi178 = call i64 @injectFault1(i64 147, i64 %125, i32 43, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @uitofp_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %129 = uitofp i64 %fi178 to double, !llfi_index !216
  %fi177 = call double @injectFault5(i64 147, double %129, i32 43, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @uitofp_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi180 = call double @injectFault5(i64 148, double %fi177, i32 21, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi181 = call double @injectFault5(i64 148, double 1.000000e+09, i32 21, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %130 = fdiv double %fi180, %fi181, !llfi_index !217, !taffo.constinfo !218
  %fi179 = call double @injectFault5(i64 148, double %130, i32 21, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi182 = call double @injectFault5(i64 149, double %fi179, i32 5, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @invoke_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %131 = invoke noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %127, double noundef %fi182)
...
135:                                              ; preds = %158, %134
  %.0 = phi i32 [ 0, %134 ], [ %fi221, %158 ], !taffo.info !109, !llfi_index !224
  %fi183 = call i32 @injectFault2(i64 152, i32 %.0, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %136 = load i32, i32* %3, align 4, !llfi_index !225
  %fi184 = call i32 @injectFault2(i64 153, i32 %136, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi186 = call i32 @injectFault2(i64 154, i32 %fi184, i32 17, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi187 = call i32 @injectFault2(i64 154, i32 2, i32 17, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %137 = mul nsw i32 %fi186, %fi187, !llfi_index !226, !taffo.constinfo !44
  %fi185 = call i32 @injectFault2(i64 154, i32 %137, i32 17, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi189 = call i32 @injectFault2(i64 155, i32 %fi185, i32 17, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi190 = call i32 @injectFault2(i64 155, i32 2, i32 17, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %138 = mul nsw i32 %fi189, %fi190, !llfi_index !227, !taffo.constinfo !44
  %fi188 = call i32 @injectFault2(i64 155, i32 %138, i32 17, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi192 = call i32 @injectFault2(i64 156, i32 %fi183, i32 53, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi193 = call i32 @injectFault2(i64 156, i32 %fi188, i32 53, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %139 = icmp slt i32 %fi192, %fi193, !taffo.info !115, !llfi_index !228
  %fi191 = call i1 @injectFault0(i64 156, i1 %139, i32 53, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi194 = call i1 @injectFault0(i64 157, i1 %fi191, i32 2, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @br_namestr, i32 0, i32 0)), !llfi_injectfault !25
  br i1 %fi194, label %140, label %160, !llfi_index !229

140:                                              ; preds = %135
  %141 = bitcast %"class.std::basic_ofstream"* %8 to %"class.std::basic_ostream"*, !llfi_index !230
  %fi196 = call i32 @injectFault2(i64 159, i32 %fi183, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi197 = call i32 @injectFault2(i64 159, i32 0, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %142 = add nsw i32 %fi196, %fi197, !taffo.info !127, !llfi_index !231, !taffo.constinfo !44
  %fi195 = call i32 @injectFault2(i64 159, i32 %142, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi199 = call i32 @injectFault2(i64 160, i32 %fi195, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %143 = sext i32 %fi199 to i64, !taffo.info !127, !llfi_index !232
  %fi198 = call i64 @injectFault1(i64 160, i64 %143, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi200 = call i64 @injectFault1(i64 161, i64 %fi198, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %s3_29fixp2 = getelementptr i32, i32* %s3_29fixp, i64 %fi200, !taffo.info !66, !llfi_index !233, !taffo.target !69
  %s3_29fixp14 = load i32, i32* %s3_29fixp2, align 4, !taffo.info !66, !llfi_index !234, !taffo.target !69
  %fi201 = call i32 @injectFault2(i64 162, i32 %s3_29fixp14, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi203 = call i32 @injectFault2(i64 163, i32 %fi201, i32 44, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @sitofp_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %144 = sitofp i32 %fi203 to float, !taffo.info !66, !llfi_index !235, !taffo.target !69
  %fi202 = call float @injectFault3(i64 163, float %144, i32 44, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @sitofp_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi205 = call float @injectFault3(i64 164, float %fi202, i32 21, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi206 = call float @injectFault3(i64 164, float 0x41C0000000000000, i32 21, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %145 = fdiv float %fi205, %fi206, !taffo.info !66, !llfi_index !236, !taffo.target !69
  %fi204 = call float @injectFault3(i64 164, float %145, i32 21, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi207 = call float @injectFault3(i64 165, float %fi204, i32 5, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @invoke_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %146 = invoke noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %141, float noundef %fi207)
...
149:                                              ; preds = %147
  %fi209 = call i32 @injectFault2(i64 167, i32 %fi183, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi210 = call i32 @injectFault2(i64 167, i32 1, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %150 = add nsw i32 %fi209, %fi210, !taffo.info !136, !llfi_index !241, !taffo.constinfo !44
  %fi208 = call i32 @injectFault2(i64 167, i32 %150, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi212 = call i32 @injectFault2(i64 168, i32 %fi208, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %151 = sext i32 %fi212 to i64, !taffo.info !136, !llfi_index !242
  %fi211 = call i64 @injectFault1(i64 168, i64 %151, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi213 = call i64 @injectFault1(i64 169, i64 %fi211, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %s3_29fixp1 = getelementptr i32, i32* %s3_29fixp, i64 %fi213, !taffo.info !66, !llfi_index !243, !taffo.target !69
  %s3_29fixp13 = load i32, i32* %s3_29fixp1, align 4, !taffo.info !66, !llfi_index !244, !taffo.target !69
  %fi214 = call i32 @injectFault2(i64 170, i32 %s3_29fixp13, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi216 = call i32 @injectFault2(i64 171, i32 %fi214, i32 44, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @sitofp_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %152 = sitofp i32 %fi216 to float, !taffo.info !66, !llfi_index !245, !taffo.target !69
  %fi215 = call float @injectFault3(i64 171, float %152, i32 44, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @sitofp_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi218 = call float @injectFault3(i64 172, float %fi215, i32 21, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi219 = call float @injectFault3(i64 172, float 0x41C0000000000000, i32 21, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %153 = fdiv float %fi218, %fi219, !taffo.info !66, !llfi_index !246, !taffo.target !69
  %fi217 = call float @injectFault3(i64 172, float %153, i32 21, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi220 = call float @injectFault3(i64 173, float %fi217, i32 5, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @invoke_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %154 = invoke noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %148, float noundef %fi220)
...
158:                                              ; preds = %157
  %fi222 = call i32 @injectFault2(i64 176, i32 %fi183, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi223 = call i32 @injectFault2(i64 176, i32 4, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %159 = add nsw i32 %fi222, %fi223, !taffo.info !143, !llfi_index !250, !taffo.constinfo !44
  %fi221 = call i32 @injectFault2(i64 176, i32 %159, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !58
...
164:                                              ; preds = %162, %38
  ...
  %fi83 = call i32 @injectFault2(i64 183, i32 %.09, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !58
  ...
  ret i32 %fi83, !llfi_index !265

165:                                              ; preds = %57, %53
  %.05 = phi i8* [ %59, %57 ], [ %55, %53 ], !llfi_index !266
  %.04 = phi i32 [ %fi55, %57 ], [ %fi52, %53 ], !llfi_index !267
  %fi13 = call i32 @injectFault2(i64 190, i32 %.04, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !58
...
166:                                              ; preds = %165, %49
  ...
  %.1 = phi i32 [ %fi13, %165 ], [ %fi49, %49 ], !llfi_index !271
...
define dso_local void @_Z10inversek2jffPfS_(float noundef %0, float noundef %1, float* noundef %2, float* noundef %3) #6 !taffo.initweight !312 !taffo.funinfo !313 !taffo.equivalentChild !368 {
  %fi96 = call float @injectFault3(i64 281, float 0x41E0000000000000, i32 18, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi97 = call float @injectFault3(i64 281, float %0, i32 18, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %5 = fmul float %fi96, %fi97, !taffo.info !74, !llfi_index !369
  %fi95 = call float @injectFault3(i64 281, float %5, i32 18, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi99 = call float @injectFault3(i64 282, float %fi95, i32 41, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fptoui_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %6 = fptoui float %fi99 to i32, !taffo.info !74, !llfi_index !370
  %fi98 = call i32 @injectFault2(i64 282, i32 %6, i32 41, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fptoui_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi101 = call float @injectFault3(i64 283, float %1, i32 18, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi102 = call float @injectFault3(i64 283, float %1, i32 18, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %7 = fmul float %fi101, %fi102, !taffo.info !74, !taffo.initweight !72, !llfi_index !371
  %fi100 = call float @injectFault3(i64 283, float %7, i32 18, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %8 = call float @llvm.fmuladd.f32(float %0, float %0, float %fi100), !taffo.info !74, !taffo.initweight !72, !llfi_index !372, !taffo.constinfo !51
  %fi107 = call float @injectFault3(i64 285, float %1, i32 18, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi108 = call float @injectFault3(i64 285, float %1, i32 18, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %9 = fmul float %fi107, %fi108, !taffo.info !74, !taffo.initweight !72, !llfi_index !373
  %fi106 = call float @injectFault3(i64 285, float %9, i32 18, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %10 = call float @llvm.fmuladd.f32(float %0, float %0, float %fi106), !taffo.info !74, !taffo.initweight !72, !llfi_index !374, !taffo.constinfo !51
  %u1_31fixp3 = load i32, i32* @l1.fixp, align 4, !taffo.info !11, !llfi_index !375
  %fi109 = call i32 @injectFault2(i64 287, i32 %u1_31fixp3, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %u1_31fixp2 = load i32, i32* @l1.fixp, align 4, !taffo.info !11, !llfi_index !376
  %fi110 = call i32 @injectFault2(i64 288, i32 %u1_31fixp2, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi112 = call i32 @injectFault2(i64 289, i32 0, i32 15, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi113 = call i32 @injectFault2(i64 289, i32 %fi109, i32 15, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %u1_31fixp10 = sub i32 %fi112, %fi113, !taffo.info !11, !llfi_index !377
  %fi111 = call i32 @injectFault2(i64 289, i32 %u1_31fixp10, i32 15, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi115 = call float @injectFault3(i64 290, float 0x41E0000000000000, i32 18, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi116 = call float @injectFault3(i64 290, float %10, i32 18, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %11 = fmul float %fi115, %fi116, !taffo.info !74, !llfi_index !378
  %fi114 = call float @injectFault3(i64 290, float %11, i32 18, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi118 = call float @injectFault3(i64 291, float %fi114, i32 41, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fptoui_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %12 = fptoui float %fi118 to i32, !taffo.info !74, !llfi_index !379
  %fi117 = call i32 @injectFault2(i64 291, i32 %12, i32 41, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fptoui_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi120 = call i32 @injectFault2(i64 292, i32 %fi111, i32 39, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %13 = zext i32 %fi120 to i64, !taffo.info !11, !llfi_index !380
  %fi119 = call i64 @injectFault1(i64 292, i64 %13, i32 39, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi122 = call i32 @injectFault2(i64 293, i32 %fi110, i32 39, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %14 = zext i32 %fi122 to i64, !taffo.info !11, !llfi_index !381
  %fi121 = call i64 @injectFault1(i64 293, i64 %14, i32 39, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi124 = call i64 @injectFault1(i64 294, i64 %fi119, i32 17, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi125 = call i64 @injectFault1(i64 294, i64 %fi121, i32 17, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %15 = mul i64 %fi124, %fi125, !taffo.info !326, !llfi_index !382
  %fi123 = call i64 @injectFault1(i64 294, i64 %15, i32 17, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi127 = call i64 @injectFault1(i64 295, i64 %fi123, i32 26, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @lshr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi128 = call i64 @injectFault1(i64 295, i64 31, i32 26, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @lshr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %16 = lshr i64 %fi127, %fi128, !llfi_index !383
  %fi126 = call i64 @injectFault1(i64 295, i64 %16, i32 26, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @lshr_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi130 = call i64 @injectFault1(i64 296, i64 %fi126, i32 38, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %17 = trunc i64 %fi130 to i32, !llfi_index !384
  %fi129 = call i32 @injectFault2(i64 296, i32 %17, i32 38, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi104 = call i32 @injectFault2(i64 297, i32 %fi129, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi105 = call i32 @injectFault2(i64 297, i32 %fi117, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %u1_31fixp14 = add i32 %fi104, %fi105, !taffo.info !11, !llfi_index !385
  %fi103 = call i32 @injectFault2(i64 297, i32 %u1_31fixp14, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %u1_31fixp8 = load i32, i32* @l2.fixp, align 4, !taffo.info !11, !llfi_index !386
  %fi131 = call i32 @injectFault2(i64 298, i32 %u1_31fixp8, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %u1_31fixp7 = load i32, i32* @l2.fixp, align 4, !taffo.info !11, !llfi_index !387
  %fi132 = call i32 @injectFault2(i64 299, i32 %u1_31fixp7, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi134 = call i32 @injectFault2(i64 300, i32 0, i32 15, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi135 = call i32 @injectFault2(i64 300, i32 %fi131, i32 15, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %u1_31fixp12 = sub i32 %fi134, %fi135, !taffo.info !11, !llfi_index !388
  %fi133 = call i32 @injectFault2(i64 300, i32 %u1_31fixp12, i32 15, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi137 = call i32 @injectFault2(i64 301, i32 %fi133, i32 39, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %18 = zext i32 %fi137 to i64, !taffo.info !11, !llfi_index !389
  %fi136 = call i64 @injectFault1(i64 301, i64 %18, i32 39, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi139 = call i32 @injectFault2(i64 302, i32 %fi132, i32 39, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %19 = zext i32 %fi139 to i64, !taffo.info !11, !llfi_index !390
  %fi138 = call i64 @injectFault1(i64 302, i64 %19, i32 39, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi141 = call i64 @injectFault1(i64 303, i64 %fi136, i32 17, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi142 = call i64 @injectFault1(i64 303, i64 %fi138, i32 17, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %20 = mul i64 %fi141, %fi142, !taffo.info !326, !llfi_index !391
  %fi140 = call i64 @injectFault1(i64 303, i64 %20, i32 17, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi144 = call i64 @injectFault1(i64 304, i64 %fi140, i32 26, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @lshr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi145 = call i64 @injectFault1(i64 304, i64 31, i32 26, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @lshr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %21 = lshr i64 %fi144, %fi145, !llfi_index !392
  %fi143 = call i64 @injectFault1(i64 304, i64 %21, i32 26, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @lshr_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi147 = call i64 @injectFault1(i64 305, i64 %fi143, i32 38, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %22 = trunc i64 %fi147 to i32, !llfi_index !393
  %fi146 = call i32 @injectFault2(i64 305, i32 %22, i32 38, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi149 = call i32 @injectFault2(i64 306, i32 %fi146, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi150 = call i32 @injectFault2(i64 306, i32 %fi103, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %u1_31fixp16 = add i32 %fi149, %fi150, !taffo.info !11, !llfi_index !394
  %fi148 = call i32 @injectFault2(i64 306, i32 %u1_31fixp16, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %u1_31fixp1 = load i32, i32* @l1.fixp, align 4, !taffo.info !11, !llfi_index !395
  %fi151 = call i32 @injectFault2(i64 307, i32 %u1_31fixp1, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi153 = call i32 @injectFault2(i64 308, i32 2, i32 39, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %23 = zext i32 %fi153 to i64, !llfi_index !396
  %fi152 = call i64 @injectFault1(i64 308, i64 %23, i32 39, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi155 = call i32 @injectFault2(i64 309, i32 %fi151, i32 39, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %24 = zext i32 %fi155 to i64, !taffo.info !11, !llfi_index !397
  %fi154 = call i64 @injectFault1(i64 309, i64 %24, i32 39, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi157 = call i64 @injectFault1(i64 310, i64 %fi152, i32 17, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi158 = call i64 @injectFault1(i64 310, i64 %fi154, i32 17, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %25 = mul i64 %fi157, %fi158, !taffo.info !398, !llfi_index !400, !taffo.constinfo !401
  %fi156 = call i64 @injectFault1(i64 310, i64 %25, i32 17, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi160 = call i64 @injectFault1(i64 311, i64 %fi156, i32 38, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %u1_31fixp9 = trunc i64 %fi160 to i32, !taffo.info !11, !llfi_index !402
  %fi159 = call i32 @injectFault2(i64 311, i32 %u1_31fixp9, i32 38, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %u1_31fixp6 = load i32, i32* @l2.fixp, align 4, !taffo.info !11, !llfi_index !403
  %fi87 = call i32 @injectFault2(i64 312, i32 %u1_31fixp6, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi89 = call i32 @injectFault2(i64 313, i32 %fi159, i32 39, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %26 = zext i32 %fi89 to i64, !taffo.info !11, !llfi_index !404
  %fi88 = call i64 @injectFault1(i64 313, i64 %26, i32 39, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi91 = call i32 @injectFault2(i64 314, i32 %fi87, i32 39, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %27 = zext i32 %fi91 to i64, !taffo.info !11, !llfi_index !405
  %fi90 = call i64 @injectFault1(i64 314, i64 %27, i32 39, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi93 = call i64 @injectFault1(i64 315, i64 %fi88, i32 17, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi94 = call i64 @injectFault1(i64 315, i64 %fi90, i32 17, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %28 = mul i64 %fi93, %fi94, !taffo.info !326, !llfi_index !406
  %fi92 = call i64 @injectFault1(i64 315, i64 %28, i32 17, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi1 = call i64 @injectFault1(i64 316, i64 %fi92, i32 26, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @lshr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi2 = call i64 @injectFault1(i64 316, i64 31, i32 26, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @lshr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %29 = lshr i64 %fi1, %fi2, !taffo.info !326, !llfi_index !407
  %fi = call i64 @injectFault1(i64 316, i64 %29, i32 26, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @lshr_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi4 = call i64 @injectFault1(i64 317, i64 %fi, i32 38, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %u1_31fixp13 = trunc i64 %fi4 to i32, !taffo.info !11, !llfi_index !408
  %fi3 = call i32 @injectFault2(i64 317, i32 %u1_31fixp13, i32 38, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi6 = call i32 @injectFault2(i64 318, i32 %fi148, i32 39, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %30 = zext i32 %fi6 to i64, !taffo.info !11, !llfi_index !409
  %fi5 = call i64 @injectFault1(i64 318, i64 %30, i32 39, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi8 = call i64 @injectFault1(i64 319, i64 %fi5, i32 25, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi9 = call i64 @injectFault1(i64 319, i64 31, i32 25, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %31 = shl i64 %fi8, %fi9, !taffo.info !11, !llfi_index !410
  %fi7 = call i64 @injectFault1(i64 319, i64 %31, i32 25, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi169 = call i32 @injectFault2(i64 320, i32 %fi3, i32 39, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %32 = zext i32 %fi169 to i64, !taffo.info !11, !llfi_index !411
  %fi168 = call i64 @injectFault1(i64 320, i64 %32, i32 39, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi171 = call i64 @injectFault1(i64 321, i64 %fi7, i32 19, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @udiv_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi172 = call i64 @injectFault1(i64 321, i64 %fi168, i32 19, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @udiv_namestr, i32 0, i32 0)), !llfi_injectfault !25
  ...
  %fi162 = call double @injectFault5(i64 327, double %fi184, i32 41, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fptoui_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %.flt.fallback.u1_31fixp = fptoui double %fi162 to i32, !taffo.info !11, !llfi_index !418
  %fi161 = call i32 @injectFault2(i64 327, i32 %.flt.fallback.u1_31fixp, i32 41, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fptoui_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi164 = call i32 @injectFault2(i64 328, i32 %fi161, i32 43, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @uitofp_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %37 = uitofp i32 %fi164 to float, !taffo.info !11, !llfi_index !419
  %fi163 = call float @injectFault3(i64 328, float %37, i32 43, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @uitofp_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi166 = call float @injectFault3(i64 329, float %fi163, i32 21, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi167 = call float @injectFault3(i64 329, float 0x41E0000000000000, i32 21, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %38 = fdiv float %fi166, %fi167, !taffo.info !11, !llfi_index !420
  %fi165 = call float @injectFault3(i64 329, float %38, i32 21, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi187 = call float @injectFault3(i64 330, float %fi165, i32 33, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @store_namestr, i32 0, i32 0)), !llfi_injectfault !25
  store float %fi187, float* %3, align 4, !taffo.info !74, !llfi_index !421, !taffo.target !422
  %fi11 = call float @injectFault3(i64 331, float %1, i32 46, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @fpext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %39 = fpext float %fi11 to double, !taffo.info !74, !taffo.initweight !72, !llfi_index !423
  %fi10 = call double @injectFault5(i64 331, double %39, i32 46, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @fpext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %u1_31fixp = load i32, i32* @l1.fixp, align 4, !taffo.info !11, !llfi_index !424
  %fi12 = call i32 @injectFault2(i64 332, i32 %u1_31fixp, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !58
  ...
  %fi14 = call i64 @injectFault1(i64 341, i64 %fi204, i32 17, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi15 = call i64 @injectFault1(i64 341, i64 %fi206, i32 17, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %47 = mul i64 %fi14, %fi15, !taffo.info !326, !llfi_index !433
  %fi13 = call i64 @injectFault1(i64 341, i64 %47, i32 17, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi17 = call i64 @injectFault1(i64 342, i64 %fi13, i32 26, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @lshr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi18 = call i64 @injectFault1(i64 342, i64 31, i32 26, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @lshr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %48 = lshr i64 %fi17, %fi18, !llfi_index !434
  %fi16 = call i64 @injectFault1(i64 342, i64 %48, i32 26, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @lshr_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi20 = call i64 @injectFault1(i64 343, i64 %fi16, i32 38, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %49 = trunc i64 %fi20 to i32, !llfi_index !435
  %fi19 = call i32 @injectFault2(i64 343, i32 %49, i32 38, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi22 = call i32 @injectFault2(i64 344, i32 %fi19, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi23 = call i32 @injectFault2(i64 344, i32 %fi12, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %u1_31fixp15 = add i32 %fi22, %fi23, !taffo.info !11, !llfi_index !436
  %fi21 = call i32 @injectFault2(i64 344, i32 %u1_31fixp15, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %u1_31fixp4 = load i32, i32* @l2.fixp, align 4, !taffo.info !11, !llfi_index !437
  %fi24 = call i32 @injectFault2(i64 345, i32 %u1_31fixp4, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi26 = call i32 @injectFault2(i64 346, i32 %fi98, i32 39, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %50 = zext i32 %fi26 to i64, !taffo.info !74, !llfi_index !438
  %fi25 = call i64 @injectFault1(i64 346, i64 %50, i32 39, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi28 = call i32 @injectFault2(i64 347, i32 %fi24, i32 39, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %51 = zext i32 %fi28 to i64, !taffo.info !11, !llfi_index !439
  %fi27 = call i64 @injectFault1(i64 347, i64 %51, i32 39, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi30 = call i64 @injectFault1(i64 348, i64 %fi25, i32 17, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi31 = call i64 @injectFault1(i64 348, i64 %fi27, i32 17, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %52 = mul i64 %fi30, %fi31, !taffo.info !326, !llfi_index !440
  %fi29 = call i64 @injectFault1(i64 348, i64 %52, i32 17, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi33 = call i64 @injectFault1(i64 349, i64 %fi29, i32 26, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @lshr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi34 = call i64 @injectFault1(i64 349, i64 31, i32 26, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @lshr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %53 = lshr i64 %fi33, %fi34, !taffo.info !326, !llfi_index !441
  %fi32 = call i64 @injectFault1(i64 349, i64 %53, i32 26, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @lshr_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi36 = call i64 @injectFault1(i64 350, i64 %fi32, i32 38, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %u1_31fixp11 = trunc i64 %fi36 to i32, !taffo.info !11, !llfi_index !442
  %fi35 = call i32 @injectFault2(i64 350, i32 %u1_31fixp11, i32 38, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %54 = load float, float* %3, align 4, !taffo.info !74, !taffo.initweight !72, !llfi_index !443, !taffo.target !422
  %fi37 = call float @injectFault3(i64 351, float %54, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi39 = call float @injectFault3(i64 352, float %fi37, i32 46, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @fpext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %55 = fpext float %fi39 to double, !taffo.info !74, !taffo.initweight !75, !llfi_index !444, !taffo.target !422
  %fi38 = call double @injectFault5(i64 352, double %55, i32 46, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @fpext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi189 = call double @injectFault5(i64 353, double %fi38, i32 56, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @call_namestr, i32 0, i32 0)), !llfi_injectfault !25
  ...
  %fi41 = call double @injectFault5(i64 355, double %fi190, i32 41, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fptoui_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %58 = fptoui double %fi41 to i32, !taffo.info !74, !llfi_index !447, !taffo.target !422
  %fi40 = call i32 @injectFault2(i64 355, i32 %58, i32 41, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fptoui_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi43 = call i32 @injectFault2(i64 356, i32 %fi35, i32 39, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %59 = zext i32 %fi43 to i64, !taffo.info !11, !llfi_index !448
  %fi42 = call i64 @injectFault1(i64 356, i64 %59, i32 39, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi45 = call i32 @injectFault2(i64 357, i32 %fi40, i32 39, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %60 = zext i32 %fi45 to i64, !taffo.info !74, !llfi_index !449, !taffo.target !422
  %fi44 = call i64 @injectFault1(i64 357, i64 %60, i32 39, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi47 = call i64 @injectFault1(i64 358, i64 %fi42, i32 17, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi48 = call i64 @injectFault1(i64 358, i64 %fi44, i32 17, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %61 = mul i64 %fi47, %fi48, !taffo.info !326, !llfi_index !450
  %fi46 = call i64 @injectFault1(i64 358, i64 %61, i32 17, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi50 = call i64 @injectFault1(i64 359, i64 %fi46, i32 26, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @lshr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi51 = call i64 @injectFault1(i64 359, i64 31, i32 26, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @lshr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %62 = lshr i64 %fi50, %fi51, !taffo.info !326, !llfi_index !451
  %fi49 = call i64 @injectFault1(i64 359, i64 %62, i32 26, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @lshr_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi53 = call i64 @injectFault1(i64 360, i64 %fi49, i32 38, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %u1_31fixp17 = trunc i64 %fi53 to i32, !taffo.info !11, !llfi_index !452
  %fi52 = call i32 @injectFault2(i64 360, i32 %u1_31fixp17, i32 38, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi55 = call i32 @injectFault2(i64 361, i32 0, i32 15, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi56 = call i32 @injectFault2(i64 361, i32 %fi52, i32 15, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %u1_31fixp19 = sub i32 %fi55, %fi56, !taffo.info !11, !llfi_index !453
  %fi54 = call i32 @injectFault2(i64 361, i32 %u1_31fixp19, i32 15, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi58 = call double @injectFault5(i64 362, double 0x41C0000000000000, i32 18, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi59 = call double @injectFault5(i64 362, double %fi10, i32 18, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %63 = fmul double %fi58, %fi59, !taffo.info !74, !llfi_index !454
  %fi57 = call double @injectFault5(i64 362, double %63, i32 18, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi61 = call double @injectFault5(i64 363, double %fi57, i32 41, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fptoui_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %64 = fptoui double %fi61 to i32, !taffo.info !74, !llfi_index !455
  %fi60 = call i32 @injectFault2(i64 363, i32 %64, i32 41, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fptoui_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi63 = call i32 @injectFault2(i64 364, i32 %fi54, i32 26, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @lshr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi64 = call i32 @injectFault2(i64 364, i32 2, i32 26, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @lshr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %65 = lshr i32 %fi63, %fi64, !taffo.info !11, !llfi_index !456
  %fi62 = call i32 @injectFault2(i64 364, i32 %65, i32 26, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @lshr_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi66 = call i32 @injectFault2(i64 365, i32 %fi60, i32 39, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %66 = zext i32 %fi66 to i64, !taffo.info !74, !llfi_index !457
  %fi65 = call i64 @injectFault1(i64 365, i64 %66, i32 39, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi68 = call i32 @injectFault2(i64 366, i32 %fi21, i32 39, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %67 = zext i32 %fi68 to i64, !taffo.info !11, !llfi_index !458
  %fi67 = call i64 @injectFault1(i64 366, i64 %67, i32 39, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi70 = call i64 @injectFault1(i64 367, i64 %fi65, i32 17, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi71 = call i64 @injectFault1(i64 367, i64 %fi67, i32 17, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %68 = mul i64 %fi70, %fi71, !taffo.info !459, !llfi_index !461
  %fi69 = call i64 @injectFault1(i64 367, i64 %68, i32 17, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi73 = call i64 @injectFault1(i64 368, i64 %fi69, i32 26, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @lshr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi74 = call i64 @injectFault1(i64 368, i64 31, i32 26, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @lshr_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %69 = lshr i64 %fi73, %fi74, !llfi_index !462
  %fi72 = call i64 @injectFault1(i64 368, i64 %69, i32 26, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @lshr_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi76 = call i64 @injectFault1(i64 369, i64 %fi72, i32 38, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %70 = trunc i64 %fi76 to i32, !llfi_index !463
  %fi75 = call i32 @injectFault2(i64 369, i32 %70, i32 38, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi78 = call i32 @injectFault2(i64 370, i32 %fi75, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi79 = call i32 @injectFault2(i64 370, i32 %fi62, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %u3_29fixp20 = add i32 %fi78, %fi79, !taffo.info !464, !llfi_index !465
  %fi77 = call i32 @injectFault2(i64 370, i32 %u3_29fixp20, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi81 = call float @injectFault3(i64 371, float 0x41C0000000000000, i32 18, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %fi82 = call float @injectFault3(i64 371, float %8, i32 18, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %71 = fmul float %fi81, %fi82, !taffo.info !74, !llfi_index !466
  %fi80 = call float @injectFault3(i64 371, float %71, i32 18, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi84 = call float @injectFault3(i64 372, float %fi80, i32 41, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fptoui_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %u3_29fixp = fptoui float %fi84 to i32, !taffo.info !467, !llfi_index !469
  %fi83 = call i32 @injectFault2(i64 372, i32 %u3_29fixp, i32 41, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fptoui_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi86 = call i32 @injectFault2(i64 373, i32 %fi77, i32 39, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !25
  %72 = zext i32 %fi86 to i64, !taffo.info !464, !llfi_index !470
  %fi85 = call i64 @injectFault1(i64 373, i64 %72, i32 39, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !58
  %fi209 = call i64 @injectFault1(i64 374, i64 %fi85, i32 25, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !25
  ...
  %fi212 = call i32 @injectFault2(i64 375, i32 %fi83, i32 39, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @zext_namestr, i32 0, i32 0)), !llfi_injectfault !25
