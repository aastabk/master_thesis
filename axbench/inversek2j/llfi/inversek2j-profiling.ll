...
define dso_local noundef i32 @main(i32 noundef %0, i8** noundef %1) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) !taffo.initweight !22 !taffo.start !23 !taffo.funinfo !24 {
  ...
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32) %4, i8* noundef %14, %"class.std::__new_allocator"* noundef nonnull align 1 dereferenceable(1) %5)
          to label %15 unwind label %39, !llfi_index !39, !taffo.constinfo !40

15:                                               ; preds = %2
  %16 = bitcast %"class.std::__new_allocator"* %5 to %"class.std::__new_allocator"*, !llfi_index !41
  call void @_ZNSt15__new_allocatorIcED2Ev(%"class.std::__new_allocator"* noundef nonnull align 1 dereferenceable(1) %16) #8, !llfi_index !42, !taffo.constinfo !43
  call void @doProfiling(i32 34)
  ...
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC1EPKcRKS3_(%"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32) %6, i8* noundef %18, %"class.std::__new_allocator"* noundef nonnull align 1 dereferenceable(1) %7)
          to label %19 unwind label %44, !llfi_index !46, !taffo.constinfo !40

19:                                               ; preds = %15
  %20 = bitcast %"class.std::__new_allocator"* %7 to %"class.std::__new_allocator"*, !llfi_index !47
  call void @_ZNSt15__new_allocatorIcED2Ev(%"class.std::__new_allocator"* noundef nonnull align 1 dereferenceable(1) %20) #8, !llfi_index !48, !taffo.constinfo !43
  invoke void @_ZNSt14basic_ofstreamIcSt11char_traitsIcEEC1Ev(%"class.std::basic_ofstream"* noundef nonnull align 8 dereferenceable(248) %8)
          to label %21 unwind label %49, !llfi_index !49, !taffo.constinfo !50
...
21:                                               ; preds = %19
  ...
  invoke void @_ZNSt14basic_ofstreamIcSt11char_traitsIcEE4openERKNSt7__cxx1112basic_stringIcS1_SaIcEEESt13_Ios_Openmode(%"class.std::basic_ofstream"* noundef nonnull align 8 dereferenceable(248) %8, %"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32) %6, i32 noundef 16)
          to label %22 unwind label %53, !llfi_index !51, !taffo.constinfo !40
...
22:                                               ; preds = %21
  ...
  invoke void @_ZNSt14basic_ifstreamIcSt11char_traitsIcEEC1ERKNSt7__cxx1112basic_stringIcS1_SaIcEEESt13_Ios_Openmode(%"class.std::basic_ifstream"* noundef nonnull align 8 dereferenceable(256) %9, %"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32) %4, i32 noundef 8)
          to label %23 unwind label %53, !llfi_index !52, !taffo.constinfo !40
...
23:                                               ; preds = %22
  ...
  %25 = invoke noundef nonnull align 8 dereferenceable(16) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* noundef nonnull align 8 dereferenceable(16) %24, i32* noundef nonnull align 4 dereferenceable(4) %3)
          to label %26 unwind label %57, !llfi_index !54, !taffo.constinfo !55

26:                                               ; preds = %23
  %27 = load i32, i32* %3, align 4, !llfi_index !56
  call void @doProfiling(i32 32)
  %28 = mul nsw i32 %27, 2, !llfi_index !57, !taffo.constinfo !43
  call void @doProfiling(i32 17)
  %29 = mul nsw i32 %28, 2, !llfi_index !58, !taffo.constinfo !43
  call void @doProfiling(i32 17)
  %30 = sext i32 %29 to i64, !llfi_index !59
  call void @doProfiling(i32 40)
  %31 = mul i64 %30, 4, !llfi_index !60, !taffo.constinfo !43
  call void @doProfiling(i32 17)
  call void @doProfiling(i32 56)
  %32 = call noalias i8* @malloc(i64 noundef %31) #9, !taffo.info !61, !llfi_index !63, !taffo.constinfo !43
  %s3_29fixp = bitcast i8* %32 to i32*, !taffo.info !64, !llfi_index !66, !taffo.target !67
  %33 = bitcast i32* %s3_29fixp to float*, !taffo.info !64, !llfi_index !68, !taffo.target !67
  %.flt = icmp eq float* %33, null, !taffo.info !69, !taffo.initweight !70, !llfi_index !71, !taffo.target !67
  call void @doProfiling(i32 53)
  call void @doProfiling(i32 2)
  br i1 %.flt, label %34, label %61, !taffo.info !72, !taffo.initweight !73, !llfi_index !74, !taffo.target !67
...
34:                                               ; preds = %26
  %35 = invoke noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cerr, i8* noundef getelementptr inbounds ([56 x i8], [56 x i8]* @.str.2, i64 0, i64 0))
          to label %36 unwind label %57, !llfi_index !75, !taffo.constinfo !55
...
36:                                               ; preds = %34
  %37 = invoke noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %35, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* noundef @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
          to label %38 unwind label %57, !llfi_index !76, !taffo.constinfo !55
...
39:                                               ; preds = %2
  ...
  call void @_ZNSt15__new_allocatorIcED2Ev(%"class.std::__new_allocator"* noundef nonnull align 1 dereferenceable(1) %43) #8, !llfi_index !82, !taffo.constinfo !43
...
44:                                               ; preds = %15
  ...
  call void @_ZNSt15__new_allocatorIcED2Ev(%"class.std::__new_allocator"* noundef nonnull align 1 dereferenceable(1) %48) #8, !llfi_index !88, !taffo.constinfo !43
...
57:                                               ; preds = %161, %160, %155, %149, %147, %140, %132, %128, %126, %124, %111, %93, %86, %72, %69, %36, %34, %23
  ...
  call void @doProfiling(i32 64)
  call void @_ZNSt14basic_ifstreamIcSt11char_traitsIcEED1Ev(%"class.std::basic_ifstream"* noundef nonnull align 8 dereferenceable(256) %9) #8, !llfi_index !101, !taffo.constinfo !43
  br label %165, !llfi_index !102

61:                                               ; preds = %26
  %62 = call i64 @time(i64* noundef null) #8, !llfi_index !103, !taffo.constinfo !43
  call void @doProfiling(i32 56)
  %63 = trunc i64 %62 to i32, !llfi_index !104
  call void @doProfiling(i32 38)
  call void @doProfiling(i32 56)
  call void @srand(i32 noundef %63) #8, !llfi_index !105, !taffo.constinfo !43
...
64:                                               ; preds = %84, %61
  ...
  call void @doProfiling(i32 32)
  %66 = mul nsw i32 %65, 2, !llfi_index !111, !taffo.constinfo !43
  call void @doProfiling(i32 17)
  %67 = mul nsw i32 %66, 2, !llfi_index !112, !taffo.constinfo !43
  call void @doProfiling(i32 17)
...
69:                                               ; preds = %64
  ...
  %71 = invoke noundef nonnull align 8 dereferenceable(16) %"class.std::basic_istream"* @_ZNSirsERf(%"class.std::basic_istream"* noundef nonnull align 8 dereferenceable(16) %70, float* noundef nonnull align 4 dereferenceable(4) %10)
          to label %72 unwind label %57, !taffo.structinfo !118, !taffo.initweight !119, !llfi_index !120, !taffo.constinfo !55
...
72:                                               ; preds = %69
  %73 = invoke noundef nonnull align 8 dereferenceable(16) %"class.std::basic_istream"* @_ZNSirsERf(%"class.std::basic_istream"* noundef nonnull align 8 dereferenceable(16) %71, float* noundef nonnull align 4 dereferenceable(4) %11)
          to label %74 unwind label %57, !taffo.structinfo !118, !taffo.initweight !119, !llfi_index !121, !taffo.constinfo !55
...
74:                                               ; preds = %72
  ...
  call void @doProfiling(i32 40)
  call void @doProfiling(i32 34)
  %s3_29fixp12 = getelementptr inbounds i32, i32* %s3_29fixp, i64 %78, !taffo.info !64, !llfi_index !128, !taffo.target !67
  ...
  call void @doProfiling(i32 42)
  %82 = add nsw i32 %.03, 1, !taffo.info !134, !llfi_index !136, !taffo.constinfo !43
  call void @doProfiling(i32 13)
  %83 = sext i32 %82 to i64, !taffo.info !134, !llfi_index !137
  call void @doProfiling(i32 40)
  call void @doProfiling(i32 34)
  %s3_29fixp11 = getelementptr inbounds i32, i32* %s3_29fixp, i64 %83, !taffo.info !64, !llfi_index !138, !taffo.target !67
  call void @doProfiling(i32 33)
  store i32 %81, i32* %s3_29fixp11, align 4, !taffo.info !129, !llfi_index !139
  br label %84, !llfi_index !140

84:                                               ; preds = %74
  %85 = add nsw i32 %.03, 4, !taffo.info !141, !llfi_index !143, !taffo.constinfo !43
  call void @doProfiling(i32 13)
...
86:                                               ; preds = %64
  invoke void @_ZN12AxBenchTimerC2Ev(%class.AxBenchTimer* noundef nonnull align 8 dereferenceable(16) %12)
          to label %87 unwind label %57, !llfi_index !147, !taffo.constinfo !50
...
88:                                               ; preds = %103, %87
  ...
  call void @doProfiling(i32 32)
  %90 = mul nsw i32 %89, 2, !llfi_index !151, !taffo.constinfo !43
  call void @doProfiling(i32 17)
  %91 = mul nsw i32 %90, 2, !llfi_index !152, !taffo.constinfo !43
  call void @doProfiling(i32 17)
...
93:                                               ; preds = %88
  %94 = add nsw i32 %.02, 0, !taffo.info !125, !llfi_index !155, !taffo.constinfo !43
  call void @doProfiling(i32 13)
  %95 = sext i32 %94 to i64, !taffo.info !125, !llfi_index !156
  call void @doProfiling(i32 40)
  call void @doProfiling(i32 34)
  %s3_29fixp10 = getelementptr inbounds i32, i32* %s3_29fixp, i64 %95, !taffo.info !64, !llfi_index !157, !taffo.target !67
  %s3_29fixp18 = load i32, i32* %s3_29fixp10, align 4, !taffo.info !158, !llfi_index !160, !taffo.target !67
  call void @doProfiling(i32 32)
  %96 = add nsw i32 %.02, 1, !taffo.info !134, !llfi_index !161, !taffo.constinfo !43
  call void @doProfiling(i32 13)
  %97 = sext i32 %96 to i64, !taffo.info !134, !llfi_index !162
  call void @doProfiling(i32 40)
  call void @doProfiling(i32 34)
  %s3_29fixp9 = getelementptr inbounds i32, i32* %s3_29fixp, i64 %97, !taffo.info !64, !llfi_index !163, !taffo.target !67
  %s3_29fixp17 = load i32, i32* %s3_29fixp9, align 4, !taffo.info !158, !llfi_index !164, !taffo.target !67
  call void @doProfiling(i32 32)
  %98 = add nsw i32 %.02, 2, !taffo.info !165, !llfi_index !167, !taffo.constinfo !43
  call void @doProfiling(i32 13)
  %99 = sext i32 %98 to i64, !taffo.info !165, !llfi_index !168
  call void @doProfiling(i32 40)
  call void @doProfiling(i32 34)
  %s3_29fixp8 = getelementptr inbounds i32, i32* %s3_29fixp, i64 %99, !taffo.info !64, !llfi_index !169, !taffo.target !67
  %100 = add nsw i32 %.02, 3, !taffo.info !170, !llfi_index !172, !taffo.constinfo !43
  call void @doProfiling(i32 13)
  %101 = sext i32 %100 to i64, !taffo.info !170, !llfi_index !173
  call void @doProfiling(i32 40)
  call void @doProfiling(i32 34)
  %s3_29fixp7 = getelementptr inbounds i32, i32* %s3_29fixp, i64 %101, !taffo.info !64, !llfi_index !174, !taffo.target !67
  call void @doProfiling(i32 5)
  invoke void @_Z10forwardk2jffPfS_.2_fixp(i32 %s3_29fixp18, i32 %s3_29fixp17, i32* %s3_29fixp8, i32* %s3_29fixp7)
          to label %102 unwind label %57, !taffo.info !72, !llfi_index !175, !taffo.constinfo !176, !taffo.target !67

102:                                              ; preds = %93
  br label %103, !llfi_index !177

103:                                              ; preds = %102
  %104 = add nsw i32 %.02, 4, !taffo.info !141, !llfi_index !178, !taffo.constinfo !43
  call void @doProfiling(i32 13)
...
106:                                              ; preds = %122, %105
  ...
  call void @doProfiling(i32 32)
  %108 = mul nsw i32 %107, 2, !llfi_index !184, !taffo.constinfo !43
  call void @doProfiling(i32 17)
  %109 = mul nsw i32 %108, 2, !llfi_index !185, !taffo.constinfo !43
  call void @doProfiling(i32 17)
...
111:                                              ; preds = %106
  %112 = add nsw i32 %.01, 2, !taffo.info !165, !llfi_index !188, !taffo.constinfo !43
  call void @doProfiling(i32 13)
  %113 = sext i32 %112 to i64, !taffo.info !165, !llfi_index !189
  call void @doProfiling(i32 40)
  call void @doProfiling(i32 34)
  %s3_29fixp6 = getelementptr inbounds i32, i32* %s3_29fixp, i64 %113, !taffo.info !64, !llfi_index !190, !taffo.target !67
  %s3_29fixp16 = load i32, i32* %s3_29fixp6, align 4, !taffo.info !191, !llfi_index !194, !taffo.target !67
  call void @doProfiling(i32 32)
  %114 = add nsw i32 %.01, 3, !taffo.info !170, !llfi_index !195, !taffo.constinfo !43
  call void @doProfiling(i32 13)
  %115 = sext i32 %114 to i64, !taffo.info !170, !llfi_index !196
  call void @doProfiling(i32 40)
  call void @doProfiling(i32 34)
  %s3_29fixp5 = getelementptr inbounds i32, i32* %s3_29fixp, i64 %115, !taffo.info !64, !llfi_index !197, !taffo.target !67
  %s3_29fixp15 = load i32, i32* %s3_29fixp5, align 4, !taffo.info !198, !llfi_index !199, !taffo.target !67
  call void @doProfiling(i32 32)
  %116 = add nsw i32 %.01, 0, !taffo.info !125, !llfi_index !200, !taffo.constinfo !43
  call void @doProfiling(i32 13)
  %117 = sext i32 %116 to i64, !taffo.info !125, !llfi_index !201
  call void @doProfiling(i32 40)
  call void @doProfiling(i32 34)
  %s3_29fixp4 = getelementptr inbounds i32, i32* %s3_29fixp, i64 %117, !taffo.info !64, !llfi_index !202, !taffo.target !67
  %118 = add nsw i32 %.01, 1, !taffo.info !134, !llfi_index !203, !taffo.constinfo !43
  call void @doProfiling(i32 13)
  %119 = sext i32 %118 to i64, !taffo.info !134, !llfi_index !204
  call void @doProfiling(i32 40)
  call void @doProfiling(i32 34)
  %s3_29fixp3 = getelementptr inbounds i32, i32* %s3_29fixp, i64 %119, !taffo.info !64, !llfi_index !205, !taffo.target !67
  %120 = ashr i32 %s3_29fixp16, 1, !taffo.info !191, !llfi_index !206, !taffo.target !67
  ...
  invoke void @_Z10inversek2jffPfS_.1_fixp(i32 %120, i32 %s3_29fixp15, i32* %s3_29fixp4, i32* %s3_29fixp3)
          to label %121 unwind label %57, !taffo.info !72, !llfi_index !207, !taffo.constinfo !176, !taffo.target !67

121:                                              ; preds = %111
  br label %122, !llfi_index !208

122:                                              ; preds = %121
  %123 = add nsw i32 %.01, 4, !taffo.info !141, !llfi_index !209, !taffo.constinfo !43
  call void @doProfiling(i32 13)
...
124:                                              ; preds = %106
  %125 = invoke noundef i64 @_ZN12AxBenchTimer20nanosecondsSinceInitEv(%class.AxBenchTimer* noundef nonnull align 8 dereferenceable(16) %12)
          to label %126 unwind label %57, !llfi_index !212, !taffo.constinfo !50
...
126:                                              ; preds = %124
  %127 = invoke noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* noundef getelementptr inbounds ([15 x i8], [15 x i8]* @.str.4, i64 0, i64 0))
          to label %128 unwind label %57, !llfi_index !213, !taffo.constinfo !55

128:                                              ; preds = %126
  %129 = uitofp i64 %125 to double, !llfi_index !214
  call void @doProfiling(i32 43)
  %130 = fdiv double %129, 1.000000e+09, !llfi_index !215, !taffo.constinfo !216
  ...
  %131 = invoke noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %127, double noundef %130)
          to label %132 unwind label %57, !llfi_index !219, !taffo.constinfo !55
...
132:                                              ; preds = %128
  %133 = invoke noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %131, i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str.5, i64 0, i64 0))
          to label %134 unwind label %57, !llfi_index !220, !taffo.constinfo !55
...
135:                                              ; preds = %158, %134
  ...
  call void @doProfiling(i32 32)
  %137 = mul nsw i32 %136, 2, !llfi_index !224, !taffo.constinfo !43
  call void @doProfiling(i32 17)
  %138 = mul nsw i32 %137, 2, !llfi_index !225, !taffo.constinfo !43
  call void @doProfiling(i32 17)
...
140:                                              ; preds = %135
  ...
  %142 = add nsw i32 %.0, 0, !taffo.info !125, !llfi_index !229, !taffo.constinfo !43
  call void @doProfiling(i32 13)
  %143 = sext i32 %142 to i64, !taffo.info !125, !llfi_index !230
  call void @doProfiling(i32 40)
  call void @doProfiling(i32 34)
  %s3_29fixp2 = getelementptr inbounds i32, i32* %s3_29fixp, i64 %143, !taffo.info !64, !llfi_index !231, !taffo.target !67
  %s3_29fixp14 = load i32, i32* %s3_29fixp2, align 4, !taffo.info !64, !llfi_index !232, !taffo.target !67
  call void @doProfiling(i32 32)
  %144 = sitofp i32 %s3_29fixp14 to float, !taffo.info !64, !llfi_index !233, !taffo.target !67
  call void @doProfiling(i32 44)
  %145 = fdiv float %144, 0x41C0000000000000, !taffo.info !64, !llfi_index !234, !taffo.target !67
  call void @doProfiling(i32 21)
  call void @doProfiling(i32 5)
  %146 = invoke noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %141, float noundef %145)
          to label %147 unwind label %57, !taffo.structinfo !43, !taffo.initweight !235, !llfi_index !236, !taffo.constinfo !55, !taffo.target !67
...
147:                                              ; preds = %140
  %148 = invoke noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %146, i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i64 0, i64 0))
          to label %149 unwind label %57, !taffo.structinfo !43, !taffo.initweight !237, !llfi_index !238, !taffo.constinfo !55, !taffo.target !67

149:                                              ; preds = %147
  %150 = add nsw i32 %.0, 1, !taffo.info !134, !llfi_index !239, !taffo.constinfo !43
  call void @doProfiling(i32 13)
  %151 = sext i32 %150 to i64, !taffo.info !134, !llfi_index !240
  call void @doProfiling(i32 40)
  call void @doProfiling(i32 34)
  %s3_29fixp1 = getelementptr inbounds i32, i32* %s3_29fixp, i64 %151, !taffo.info !64, !llfi_index !241, !taffo.target !67
  %s3_29fixp13 = load i32, i32* %s3_29fixp1, align 4, !taffo.info !64, !llfi_index !242, !taffo.target !67
  call void @doProfiling(i32 32)
  %152 = sitofp i32 %s3_29fixp13 to float, !taffo.info !64, !llfi_index !243, !taffo.target !67
  call void @doProfiling(i32 44)
  %153 = fdiv float %152, 0x41C0000000000000, !taffo.info !64, !llfi_index !244, !taffo.target !67
  call void @doProfiling(i32 21)
  call void @doProfiling(i32 5)
  %154 = invoke noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %148, float noundef %153)
          to label %155 unwind label %57, !taffo.structinfo !43, !taffo.initweight !235, !llfi_index !245, !taffo.constinfo !55, !taffo.target !67
...
155:                                              ; preds = %149
  %156 = invoke noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %154, i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i64 0, i64 0))
          to label %157 unwind label %57, !taffo.structinfo !43, !taffo.initweight !237, !llfi_index !246, !taffo.constinfo !55, !taffo.target !67

157:                                              ; preds = %155
  br label %158, !llfi_index !247

158:                                              ; preds = %157
  %159 = add nsw i32 %.0, 4, !taffo.info !141, !llfi_index !248, !taffo.constinfo !43
  call void @doProfiling(i32 13)
...
160:                                              ; preds = %135
  invoke void @_ZNSt14basic_ifstreamIcSt11char_traitsIcEE5closeEv(%"class.std::basic_ifstream"* noundef nonnull align 8 dereferenceable(256) %9)
          to label %161 unwind label %57, !llfi_index !251, !taffo.constinfo !50
...
161:                                              ; preds = %160
  invoke void @_ZNSt14basic_ofstreamIcSt11char_traitsIcEE5closeEv(%"class.std::basic_ofstream"* noundef nonnull align 8 dereferenceable(248) %8)
          to label %162 unwind label %57, !llfi_index !252, !taffo.constinfo !50

162:                                              ; preds = %161
  %163 = bitcast i32* %s3_29fixp to i8*, !taffo.info !69, !llfi_index !253, !taffo.target !67
  call void @free(i8* noundef %163) #8, !taffo.info !72, !taffo.initweight !73, !llfi_index !254, !taffo.constinfo !43, !taffo.target !67
  br label %164, !llfi_index !255

164:                                              ; preds = %162, %38
  %.09 = phi i32 [ -1, %38 ], [ 0, %162 ], !taffo.info !256, !llfi_index !258
  call void @doProfiling(i32 55)
  call void @_ZNSt14basic_ifstreamIcSt11char_traitsIcEED1Ev(%"class.std::basic_ifstream"* noundef nonnull align 8 dereferenceable(256) %9) #8, !llfi_index !259, !taffo.constinfo !43
  call void @_ZNSt14basic_ofstreamIcSt11char_traitsIcEED1Ev(%"class.std::basic_ofstream"* noundef nonnull align 8 dereferenceable(248) %8) #8, !llfi_index !260, !taffo.constinfo !43
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32) %6) #8, !llfi_index !261, !taffo.constinfo !43
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32) %4) #8, !llfi_index !262, !taffo.constinfo !43
...
165:                                              ; preds = %57, %53
  ...
  call void @doProfiling(i32 55)
  call void @_ZNSt14basic_ofstreamIcSt11char_traitsIcEED1Ev(%"class.std::basic_ofstream"* noundef nonnull align 8 dereferenceable(248) %8) #8, !llfi_index !266, !taffo.constinfo !43
...
166:                                              ; preds = %165, %49
  ...
  call void @doProfiling(i32 55)
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32) %6) #8, !llfi_index !270, !taffo.constinfo !43
...
167:                                              ; preds = %166, %44
  ...
  call void @doProfiling(i32 55)
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* noundef nonnull align 8 dereferenceable(32) %4) #8, !llfi_index !274, !taffo.constinfo !43
...
define linkonce_odr dso_local void @_ZN12AxBenchTimerC2Ev(%class.AxBenchTimer* noundef nonnull align 8 dereferenceable(16) %0) unnamed_addr #5 comdat align 2 !taffo.initweight !283 !taffo.funinfo !286 {
  call void @_ZN12AxBenchTimer5resetEv(%class.AxBenchTimer* noundef nonnull align 8 dereferenceable(16) %0), !llfi_index !287, !taffo.constinfo !43
...
define linkonce_odr dso_local noundef i64 @_ZN12AxBenchTimer20nanosecondsSinceInitEv(%class.AxBenchTimer* noundef nonnull align 8 dereferenceable(16) %0) #6 comdat align 2 !taffo.initweight !283 !taffo.funinfo !286 {
  ...
  %3 = call i32 @clock_gettime(i32 noundef 4, %struct.timespec* noundef %2) #8, !llfi_index !290, !taffo.constinfo !118
  call void @doProfiling(i32 56)
  call void @doProfiling(i32 34)
  ...
  call void @doProfiling(i32 32)
  %10 = mul nsw i64 %9, 1000000000, !llfi_index !297, !taffo.constinfo !43
  call void @doProfiling(i32 17)
  ...
  call void @doProfiling(i32 32)
  %16 = mul nsw i64 %15, 1000000000, !llfi_index !303, !taffo.constinfo !43
  call void @doProfiling(i32 17)
...
define linkonce_odr dso_local void @_ZN12AxBenchTimer5resetEv(%class.AxBenchTimer* noundef nonnull align 8 dereferenceable(16) %0) #6 comdat align 2 !taffo.initweight !283 !taffo.funinfo !286 {
  ...
  %3 = call i32 @clock_gettime(i32 noundef 4, %struct.timespec* noundef %2) #8, !llfi_index !308, !taffo.constinfo !118
  call void @doProfiling(i32 56)
...
define dso_local void @_Z10forwardk2jffPfS_(float noundef %0, float noundef %1, float* noundef %2, float* noundef %3) #6 !taffo.initweight !310 !taffo.funinfo !311 !taffo.equivalentChild !312 {
  ...
  %6 = call double @cos(double noundef %5) #8, !taffo.info !72, !taffo.initweight !73, !llfi_index !315, !taffo.constinfo !43
  call void @doProfiling(i32 56)
  ...
  call void @doProfiling(i32 46)
  %9 = call double @cos(double noundef %8) #8, !taffo.info !72, !taffo.initweight !235, !llfi_index !319, !taffo.constinfo !43
  call void @doProfiling(i32 56)
  %10 = fmul double 0x41E0000000000000, %9, !taffo.info !72, !llfi_index !320, !taffo.constinfo !43
  call void @doProfiling(i32 18)
  ...
  call void @doProfiling(i32 38)
  %16 = fmul double 0x41E0000000000000, %6, !taffo.info !72, !llfi_index !329, !taffo.constinfo !43
  call void @doProfiling(i32 18)
  ...
  call void @doProfiling(i32 46)
  %26 = call double @sin(double noundef %25) #8, !taffo.info !72, !taffo.initweight !73, !llfi_index !342, !taffo.constinfo !43
  call void @doProfiling(i32 56)
  ...
  call void @doProfiling(i32 46)
  %29 = call double @sin(double noundef %28) #8, !taffo.info !72, !taffo.initweight !235, !llfi_index !346, !taffo.constinfo !43
  call void @doProfiling(i32 56)
  %30 = fmul double 0x41E0000000000000, %29, !taffo.info !72, !llfi_index !347, !taffo.constinfo !43
  call void @doProfiling(i32 18)
  ...
  call void @doProfiling(i32 38)
  %36 = fmul double 0x41E0000000000000, %26, !taffo.info !72, !llfi_index !354, !taffo.constinfo !43
  call void @doProfiling(i32 18)
...
define dso_local void @_Z10inversek2jffPfS_(float noundef %0, float noundef %1, float* noundef %2, float* noundef %3) #6 !taffo.initweight !310 !taffo.funinfo !311 !taffo.equivalentChild !366 {
  ...
  call void @doProfiling(i32 18)
  %8 = call float @llvm.fmuladd.f32(float %0, float %0, float %7), !taffo.info !72, !taffo.initweight !70, !llfi_index !370, !taffo.constinfo !50
  call void @doProfiling(i32 56)
  %9 = fmul float %1, %1, !taffo.info !72, !taffo.initweight !70, !llfi_index !371
  call void @doProfiling(i32 18)
  %10 = call float @llvm.fmuladd.f32(float %0, float %0, float %9), !taffo.info !72, !taffo.initweight !70, !llfi_index !372, !taffo.constinfo !50
  call void @doProfiling(i32 56)
  ...
  call void @doProfiling(i32 39)
  %25 = mul i64 %23, %24, !taffo.info !396, !llfi_index !398, !taffo.constinfo !399
  call void @doProfiling(i32 17)
  ...
  call void @doProfiling(i32 21)
  %.flt = call double @acos(double noundef %35) #8, !taffo.info !11, !taffo.initweight !237, !llfi_index !414, !taffo.constinfo !43
  call void @doProfiling(i32 56)
  %36 = fmul double 0x41E0000000000000, %.flt, !taffo.info !11, !llfi_index !415, !taffo.constinfo !43
  call void @doProfiling(i32 18)
  ...
  call void @doProfiling(i32 21)
  call void @doProfiling(i32 33)
  store float %38, float* %3, align 4, !taffo.info !72, !llfi_index !419, !taffo.target !420
  ...
  call void @doProfiling(i32 32)
  %40 = load float, float* %3, align 4, !taffo.info !72, !taffo.initweight !70, !llfi_index !424, !taffo.target !420
  call void @doProfiling(i32 32)
  %41 = fpext float %40 to double, !taffo.info !72, !taffo.initweight !73, !llfi_index !425, !taffo.target !420
  call void @doProfiling(i32 46)
  %42 = call double @cos(double noundef %41) #8, !taffo.info !72, !taffo.initweight !235, !llfi_index !426, !taffo.constinfo !43, !taffo.target !420
  call void @doProfiling(i32 56)
  %43 = fmul double 0x41E0000000000000, %42, !taffo.info !72, !llfi_index !427, !taffo.constinfo !43, !taffo.target !420
  call void @doProfiling(i32 18)
  %44 = fptoui double %43 to i32, !taffo.info !72, !llfi_index !428, !taffo.target !420
  call void @doProfiling(i32 41)
  %45 = zext i32 %u1_31fixp5 to i64, !taffo.info !11, !llfi_index !429
  call void @doProfiling(i32 39)
  %46 = zext i32 %44 to i64, !taffo.info !72, !llfi_index !430, !taffo.target !420
  call void @doProfiling(i32 39)
  ...
  call void @doProfiling(i32 38)
  %54 = load float, float* %3, align 4, !taffo.info !72, !taffo.initweight !70, !llfi_index !441, !taffo.target !420
  call void @doProfiling(i32 32)
  %55 = fpext float %54 to double, !taffo.info !72, !taffo.initweight !73, !llfi_index !442, !taffo.target !420
  call void @doProfiling(i32 46)
  %56 = call double @sin(double noundef %55) #8, !taffo.info !72, !taffo.initweight !235, !llfi_index !443, !taffo.constinfo !43, !taffo.target !420
  call void @doProfiling(i32 56)
  %57 = fmul double 0x41E0000000000000, %56, !taffo.info !72, !llfi_index !444, !taffo.constinfo !43, !taffo.target !420
  call void @doProfiling(i32 18)
  %58 = fptoui double %57 to i32, !taffo.info !72, !llfi_index !445, !taffo.target !420
  call void @doProfiling(i32 41)
  %59 = zext i32 %u1_31fixp11 to i64, !taffo.info !11, !llfi_index !446
  call void @doProfiling(i32 39)
  %60 = zext i32 %58 to i64, !taffo.info !72, !llfi_index !447, !taffo.target !420
  call void @doProfiling(i32 39)
  ...
  call void @doProfiling(i32 21)
  %.flt22 = call double @asin(double noundef %77) #8, !taffo.info !465, !taffo.initweight !235, !llfi_index !477, !taffo.constinfo !43
  call void @doProfiling(i32 56)
  %78 = fmul double 0x41C0000000000000, %.flt22, !taffo.info !465, !llfi_index !478, !taffo.constinfo !43
  call void @doProfiling(i32 18)
  ...
  call void @doProfiling(i32 21)
  call void @doProfiling(i32 33)
  store float %80, float* %2, align 4, !taffo.info !72, !llfi_index !482, !taffo.target !420
...
define internal void @_Z10inversek2jffPfS_.1_fixp(i32 noundef %.s4_28fixp, i32 noundef %.s3_29fixp, i32* noundef %.s3_29fixp1, i32* noundef %.s3_29fixp2) #6 !taffo.initweight !484 !taffo.funinfo !485 !taffo.sourceFunction !486 {
  ...
  call void @doProfiling(i32 39)
  %36 = mul i64 %34, %35, !taffo.info !556, !llfi_index !557, !taffo.constinfo !399
  call void @doProfiling(i32 17)
  ...
  call void @doProfiling(i32 21)
  %.flt25 = call double @acos(double noundef %47) #8, !taffo.info !578, !taffo.initweight !237, !llfi_index !580, !taffo.constinfo !43
  call void @doProfiling(i32 56)
  %48 = fmul double 0x41C0000000000000, %.flt25, !taffo.info !578, !llfi_index !581, !taffo.constinfo !43
  call void @doProfiling(i32 18)
  %.flt25.fallback.u3_29fixp = fptoui double %48 to i32, !taffo.info !582, !llfi_index !584
  call void @doProfiling(i32 41)
  call void @doProfiling(i32 33)
  store i32 %.flt25.fallback.u3_29fixp, i32* %.s3_29fixp2, align 4, !taffo.info !72, !llfi_index !585, !taffo.target !420
  ...
  call void @doProfiling(i32 32)
  %s3_29fixp = load i32, i32* %.s3_29fixp2, align 4, !taffo.info !198, !llfi_index !588, !taffo.target !420
  call void @doProfiling(i32 32)
  %49 = sitofp i32 %s3_29fixp to double, !taffo.info !198, !llfi_index !589, !taffo.target !420
  call void @doProfiling(i32 44)
  %50 = fdiv double %49, 0x41C0000000000000, !taffo.info !198, !llfi_index !590, !taffo.target !420
  call void @doProfiling(i32 21)
  %.flt = call double @cos(double noundef %50) #8, !taffo.info !591, !taffo.initweight !235, !llfi_index !593, !taffo.constinfo !43, !taffo.target !420
  call void @doProfiling(i32 56)
  %51 = fmul double 0x41D0000000000000, %.flt, !taffo.info !591, !llfi_index !594, !taffo.constinfo !43, !taffo.target !420
  call void @doProfiling(i32 18)
  %.flt.fallback.s2_30fixp = fptosi double %51 to i32, !taffo.info !591, !llfi_index !595, !taffo.target !420
  call void @doProfiling(i32 42)
  %52 = lshr i32 %u1_31fixp, 1, !taffo.info !11, !llfi_index !596
  call void @doProfiling(i32 26)
  %53 = zext i32 %u1_31fixp9 to i64, !taffo.info !11, !llfi_index !597
  call void @doProfiling(i32 39)
  %54 = sext i32 %.flt.fallback.s2_30fixp to i64, !taffo.info !591, !llfi_index !598, !taffo.target !420
  call void @doProfiling(i32 40)
  ...
  call void @doProfiling(i32 38)
  %s3_29fixp4 = load i32, i32* %.s3_29fixp2, align 4, !taffo.info !198, !llfi_index !615, !taffo.target !420
  call void @doProfiling(i32 32)
  %62 = sitofp i32 %s3_29fixp4 to double, !taffo.info !198, !llfi_index !616, !taffo.target !420
  call void @doProfiling(i32 44)
  %63 = fdiv double %62, 0x41C0000000000000, !taffo.info !198, !llfi_index !617, !taffo.target !420
  call void @doProfiling(i32 21)
  %.flt17 = call double @sin(double noundef %63) #8, !taffo.info !618, !taffo.initweight !235, !llfi_index !620, !taffo.constinfo !43, !taffo.target !420
  call void @doProfiling(i32 56)
  %64 = fmul double 0x41C0000000000000, %.flt17, !taffo.info !618, !llfi_index !621, !taffo.constinfo !43, !taffo.target !420
  call void @doProfiling(i32 18)
  %.flt17.fallback.s3_29fixp = fptosi double %64 to i32, !taffo.info !618, !llfi_index !622, !taffo.target !420
  call void @doProfiling(i32 42)
  %65 = sext i32 %s2_30fixp to i64, !taffo.info !613, !llfi_index !623
  call void @doProfiling(i32 40)
  %66 = sext i32 %.flt17.fallback.s3_29fixp to i64, !taffo.info !618, !llfi_index !624, !taffo.target !420
  call void @doProfiling(i32 40)
  ...
  call void @doProfiling(i32 21)
  %.flt27 = call double @asin(double noundef %81) #8, !taffo.info !656, !taffo.initweight !235, !llfi_index !658, !taffo.constinfo !43
  call void @doProfiling(i32 56)
  %82 = fmul double 0x41B0000000000000, %.flt27, !taffo.info !656, !llfi_index !659, !taffo.constinfo !43
  call void @doProfiling(i32 18)
  ...
  call void @doProfiling(i32 25)
  call void @doProfiling(i32 33)
  store i32 %s3_29fixp28, i32* %.s3_29fixp1, align 4, !taffo.info !72, !llfi_index !663, !taffo.target !420
...
define internal void @_Z10forwardk2jffPfS_.2_fixp(i32 noundef %.u3_29fixp, i32 noundef %.u3_29fixp1, i32* noundef %.s3_29fixp, i32* noundef %.s3_29fixp2) #6 !taffo.initweight !484 !taffo.funinfo !665 !taffo.sourceFunction !666 {
  ...
  call void @doProfiling(i32 21)
  %.flt = call double @cos(double noundef %2) #8, !taffo.info !674, !taffo.initweight !73, !llfi_index !676, !taffo.constinfo !43
  call void @doProfiling(i32 56)
  %3 = fmul double 0x41D0000000000000, %.flt, !taffo.info !674, !llfi_index !677, !taffo.constinfo !43
  call void @doProfiling(i32 18)
  ...
  call void @doProfiling(i32 21)
  %.flt13 = call double @cos(double noundef %5) #8, !taffo.info !688, !taffo.initweight !235, !llfi_index !690, !taffo.constinfo !43
  call void @doProfiling(i32 56)
  %6 = fmul double 0x41B0000000000000, %.flt13, !taffo.info !688, !llfi_index !691, !taffo.constinfo !43
  call void @doProfiling(i32 18)
  ...
  call void @doProfiling(i32 21)
  %.flt8 = call double @sin(double noundef %18) #8, !taffo.info !720, !taffo.initweight !73, !llfi_index !722, !taffo.constinfo !43
  call void @doProfiling(i32 56)
  %19 = fmul double 0x41D0000000000000, %.flt8, !taffo.info !720, !llfi_index !723, !taffo.constinfo !43
  call void @doProfiling(i32 18)
  ...
  call void @doProfiling(i32 21)
  %.flt14 = call double @sin(double noundef %21) #8, !taffo.info !731, !taffo.initweight !235, !llfi_index !732, !taffo.constinfo !43
  call void @doProfiling(i32 56)
  %22 = fmul double 0x41B0000000000000, %.flt14, !taffo.info !731, !llfi_index !733, !taffo.constinfo !43
  call void @doProfiling(i32 18)
...
!38 = !{i64 12}
!39 = !{i64 13}
!40 = !{i1 false, i1 false, i1 false, i1 false, i1 false, i1 false}
!41 = !{i64 14}
!42 = !{i64 15}
...
!174 = !{i64 114}
!175 = !{i64 115}
!176 = !{i1 false, i1 false, i1 false, i1 false, i1 false, i1 false, i1 false}
!177 = !{i64 116}
!178 = !{i64 117}
...
!218 = !{double 1.000000e+09, double 1.000000e+09}
!219 = !{i64 149}
!220 = !{i64 150}
!221 = !{i64 151}
!222 = !{i64 152}
