...
define dso_local void @_Z14calcFftIndicesiPi(i32 noundef %0, i32* noundef %1) #0 !taffo.initweight !57 !taffo.equivalentChild !276 !taffo.funinfo !58 {
  %fi10 = call i32 @injectFault1(i64 191, i32 %0, i32 44, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @sitofp_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %3 = sitofp i32 %fi10 to float, !llfi_index !277
  %fi9 = call float @injectFault3(i64 191, float %3, i32 44, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @sitofp_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi12 = call float @injectFault3(i64 192, float %fi9, i32 56, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @call_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %4 = call float @log2f(float noundef %fi12) #11, !llfi_index !278, !taffo.constinfo !45
  %fi11 = call float @injectFault3(i64 192, float %4, i32 56, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @call_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi14 = call float @injectFault3(i64 193, float %fi11, i32 42, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fptosi_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %5 = fptosi float %fi14 to i32, !llfi_index !279
  %fi13 = call i32 @injectFault1(i64 193, i32 %5, i32 42, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fptosi_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi15 = call i64 @injectFault2(i64 194, i64 0, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %6 = getelementptr i32, i32* %1, i64 %fi15, !llfi_index !280
  %fi16 = call i32 @injectFault1(i64 195, i32 0, i32 33, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @store_namestr, i32 0, i32 0)), !llfi_injectfault !34
  store i32 %fi16, i32* %6, align 4, !llfi_index !281, !taffo.constinfo !45
  %fi18 = call i32 @injectFault1(i64 196, i32 %fi13, i32 15, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi19 = call i32 @injectFault1(i64 196, i32 1, i32 15, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %7 = sub nsw i32 %fi18, %fi19, !llfi_index !282, !taffo.constinfo !45
  %fi17 = call i32 @injectFault1(i64 196, i32 %7, i32 15, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi21 = call i32 @injectFault1(i64 197, i32 1, i32 25, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi22 = call i32 @injectFault1(i64 197, i32 %fi17, i32 25, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %8 = shl i32 %fi21, %fi22, !llfi_index !283, !taffo.constinfo !45
  %fi20 = call i32 @injectFault1(i64 197, i32 %8, i32 25, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi26 = call i64 @injectFault2(i64 198, i64 1, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %9 = getelementptr i32, i32* %1, i64 %fi26, !llfi_index !284
  %fi27 = call i32 @injectFault1(i64 199, i32 %fi20, i32 33, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @store_namestr, i32 0, i32 0)), !llfi_injectfault !34
  store i32 %fi27, i32* %9, align 4, !llfi_index !285
  br label %10, !llfi_index !286

10:                                               ; preds = %33, %2
  %.01 = phi i32 [ 1, %2 ], [ %fi64, %33 ], !llfi_index !287
  %fi28 = call i32 @injectFault1(i64 201, i32 %.01, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi30 = call i32 @injectFault1(i64 202, i32 %fi28, i32 53, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi31 = call i32 @injectFault1(i64 202, i32 %fi13, i32 53, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %11 = icmp slt i32 %fi30, %fi31, !llfi_index !288
  %fi29 = call i1 @injectFault4(i64 202, i1 %11, i32 53, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi32 = call i1 @injectFault4(i64 203, i1 %fi29, i32 2, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @br_namestr, i32 0, i32 0)), !llfi_injectfault !34
  br i1 %fi32, label %12, label %35, !llfi_index !289

12:                                               ; preds = %10
  %fi34 = call i32 @injectFault1(i64 204, i32 1, i32 25, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi35 = call i32 @injectFault1(i64 204, i32 %fi28, i32 25, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %13 = shl i32 %fi34, %fi35, !llfi_index !290, !taffo.constinfo !45
  %fi33 = call i32 @injectFault1(i64 204, i32 %13, i32 25, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !37
  br label %14, !llfi_index !291

14:                                               ; preds = %30, %12
  %.0 = phi i32 [ %fi33, %12 ], [ %fi61, %30 ], !llfi_index !292
  %fi36 = call i32 @injectFault1(i64 206, i32 %.0, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi38 = call i32 @injectFault1(i64 207, i32 %fi28, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi39 = call i32 @injectFault1(i64 207, i32 1, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %15 = add nsw i32 %fi38, %fi39, !llfi_index !293, !taffo.constinfo !45
  %fi37 = call i32 @injectFault1(i64 207, i32 %15, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi41 = call i32 @injectFault1(i64 208, i32 1, i32 25, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi42 = call i32 @injectFault1(i64 208, i32 %fi37, i32 25, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %16 = shl i32 %fi41, %fi42, !llfi_index !294, !taffo.constinfo !45
  %fi40 = call i32 @injectFault1(i64 208, i32 %16, i32 25, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi24 = call i32 @injectFault1(i64 209, i32 %fi36, i32 53, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi25 = call i32 @injectFault1(i64 209, i32 %fi40, i32 53, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %17 = icmp slt i32 %fi24, %fi25, !llfi_index !295
  %fi23 = call i1 @injectFault4(i64 209, i1 %17, i32 53, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi43 = call i1 @injectFault4(i64 210, i1 %fi23, i32 2, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @br_namestr, i32 0, i32 0)), !llfi_injectfault !34
  br i1 %fi43, label %18, label %32, !llfi_index !296

18:                                               ; preds = %14
  %fi45 = call i32 @injectFault1(i64 211, i32 1, i32 25, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi46 = call i32 @injectFault1(i64 211, i32 %fi28, i32 25, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %19 = shl i32 %fi45, %fi46, !llfi_index !297, !taffo.constinfo !45
  %fi44 = call i32 @injectFault1(i64 211, i32 %19, i32 25, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi48 = call i32 @injectFault1(i64 212, i32 %fi36, i32 15, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi49 = call i32 @injectFault1(i64 212, i32 %fi44, i32 15, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %20 = sub nsw i32 %fi48, %fi49, !llfi_index !298
  %fi47 = call i32 @injectFault1(i64 212, i32 %20, i32 15, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi51 = call i32 @injectFault1(i64 213, i32 %fi47, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %21 = sext i32 %fi51 to i64, !llfi_index !299
  %fi50 = call i64 @injectFault2(i64 213, i64 %21, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi52 = call i64 @injectFault2(i64 214, i64 %fi50, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %22 = getelementptr i32, i32* %1, i64 %fi52, !llfi_index !300
  %23 = load i32, i32* %22, align 4, !llfi_index !301
  %fi53 = call i32 @injectFault1(i64 215, i32 %23, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi55 = call i32 @injectFault1(i64 216, i32 %fi28, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi56 = call i32 @injectFault1(i64 216, i32 1, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %24 = add nsw i32 %fi55, %fi56, !llfi_index !302, !taffo.constinfo !45
  %fi54 = call i32 @injectFault1(i64 216, i32 %24, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi1 = call i32 @injectFault1(i64 217, i32 %fi13, i32 15, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi2 = call i32 @injectFault1(i64 217, i32 %fi54, i32 15, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %25 = sub nsw i32 %fi1, %fi2, !llfi_index !303
  %fi = call i32 @injectFault1(i64 217, i32 %25, i32 15, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi4 = call i32 @injectFault1(i64 218, i32 1, i32 25, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi5 = call i32 @injectFault1(i64 218, i32 %fi, i32 25, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %26 = shl i32 %fi4, %fi5, !llfi_index !304, !taffo.constinfo !45
  %fi3 = call i32 @injectFault1(i64 218, i32 %26, i32 25, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi7 = call i32 @injectFault1(i64 219, i32 %fi53, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi8 = call i32 @injectFault1(i64 219, i32 %fi3, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %27 = add nsw i32 %fi7, %fi8, !llfi_index !305
  %fi6 = call i32 @injectFault1(i64 219, i32 %27, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi58 = call i32 @injectFault1(i64 220, i32 %fi36, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %28 = sext i32 %fi58 to i64, !llfi_index !306
  %fi57 = call i64 @injectFault2(i64 220, i64 %28, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi59 = call i64 @injectFault2(i64 221, i64 %fi57, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %29 = getelementptr i32, i32* %1, i64 %fi59, !llfi_index !307
  %fi60 = call i32 @injectFault1(i64 222, i32 %fi6, i32 33, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @store_namestr, i32 0, i32 0)), !llfi_injectfault !34
  store i32 %fi60, i32* %29, align 4, !llfi_index !308
  br label %30, !llfi_index !309

30:                                               ; preds = %18
  %fi62 = call i32 @injectFault1(i64 224, i32 %fi36, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
...
33:                                               ; preds = %32
  %fi65 = call i32 @injectFault1(i64 227, i32 %fi28, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
...
define dso_local void @_Z23radix2DitCooleyTykeyFftiPiP7ComplexS1_(i32 noundef %0, i32* noundef %1, %struct.Complex* noundef %2, %struct.Complex* noundef %3) #8 !taffo.initweight !318 !taffo.equivalentChild !319 !taffo.funinfo !320 {
  %fi44 = call i32 @injectFault1(i64 230, i32 1, i32 31, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @alloca_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %5 = alloca float, i32 %fi44, align 4, !taffo.info !33, !taffo.initweight !2, !llfi_index !321
  %fi45 = call i32 @injectFault1(i64 231, i32 1, i32 31, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @alloca_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %6 = alloca float, i32 %fi45, align 4, !taffo.info !33, !taffo.initweight !2, !llfi_index !322
  %fi46 = call i32 @injectFault1(i64 232, i32 1, i32 31, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @alloca_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %7 = alloca { i32, i32 }, i32 %fi46, align 4, !llfi_index !323
  %fi47 = call i32 @injectFault1(i64 233, i32 %0, i32 56, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @call_namestr, i32 0, i32 0)), !llfi_injectfault !34
  call void @_Z14calcFftIndicesiPi.2(i32 noundef %fi47, i32* noundef %1), !taffo.info !324, !taffo.initweight !35, !llfi_index !326, !taffo.constinfo !256, !taffo.originalCall !327
  %fi49 = call i32 @injectFault1(i64 234, i32 0, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi50 = call i32 @injectFault1(i64 234, i32 1, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %8 = add nsw i32 %fi49, %fi50, !llfi_index !328, !taffo.constinfo !45
  %fi48 = call i32 @injectFault1(i64 234, i32 %8, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi55 = call i32 @injectFault1(i64 235, i32 1, i32 25, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi56 = call i32 @injectFault1(i64 235, i32 %fi48, i32 25, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %9 = shl i32 %fi55, %fi56, !llfi_index !329, !taffo.constinfo !45
  %fi54 = call i32 @injectFault1(i64 235, i32 %9, i32 25, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !37
  br label %10, !llfi_index !330

10:                                               ; preds = %141, %4
  %.04 = phi i32 [ 0, %4 ], [ %fi222, %141 ], !llfi_index !331
  %.03 = phi i32 [ %fi54, %4 ], [ %fi228, %141 ], !llfi_index !332
  %fi58 = call i32 @injectFault1(i64 238, i32 %.03, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi57 = call i32 @injectFault1(i64 237, i32 %.04, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi60 = call i32 @injectFault1(i64 239, i32 %fi58, i32 53, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi61 = call i32 @injectFault1(i64 239, i32 %0, i32 53, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %11 = icmp sle i32 %fi60, %fi61, !llfi_index !333
  %fi59 = call i1 @injectFault4(i64 239, i1 %11, i32 53, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi62 = call i1 @injectFault4(i64 240, i1 %fi59, i32 2, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @br_namestr, i32 0, i32 0)), !llfi_injectfault !34
  br i1 %fi62, label %12, label %145, !llfi_index !334
...
13:                                               ; preds = %138, %12
  ...
  %fi63 = call i32 @injectFault1(i64 242, i32 %.02, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi65 = call i32 @injectFault1(i64 243, i32 %fi63, i32 53, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi66 = call i32 @injectFault1(i64 243, i32 %0, i32 53, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %14 = icmp slt i32 %fi65, %fi66, !llfi_index !337
  %fi64 = call i1 @injectFault4(i64 243, i1 %14, i32 53, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi67 = call i1 @injectFault4(i64 244, i1 %fi64, i32 2, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @br_namestr, i32 0, i32 0)), !llfi_injectfault !34
  br i1 %fi67, label %15, label %140, !llfi_index !338

15:                                               ; preds = %13
  %fi69 = call i32 @injectFault1(i64 245, i32 %fi58, i32 27, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi70 = call i32 @injectFault1(i64 245, i32 1, i32 27, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %16 = ashr i32 %fi69, %fi70, !llfi_index !339, !taffo.constinfo !45
  %fi68 = call i32 @injectFault1(i64 245, i32 %16, i32 27, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !37
  br label %17, !llfi_index !340

17:                                               ; preds = %135, %15
  %.01 = phi i32 [ 0, %15 ], [ %fi39, %135 ], !taffo.info !324, !taffo.initweight !2, !llfi_index !341
  %fi43 = call i32 @injectFault1(i64 247, i32 %.01, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi52 = call i32 @injectFault1(i64 248, i32 %fi43, i32 53, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi53 = call i32 @injectFault1(i64 248, i32 %fi68, i32 53, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %18 = icmp slt i32 %fi52, %fi53, !taffo.info !324, !taffo.initweight !35, !llfi_index !342
  %fi51 = call i1 @injectFault4(i64 248, i1 %18, i32 53, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi73 = call i1 @injectFault4(i64 249, i1 %fi51, i32 2, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @br_namestr, i32 0, i32 0)), !llfi_injectfault !34
  br i1 %fi73, label %19, label %137, !taffo.info !324, !taffo.initweight !38, !llfi_index !343

19:                                               ; preds = %17
  %fi75 = call i32 @injectFault1(i64 250, i32 %fi43, i32 44, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @sitofp_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %20 = sitofp i32 %fi75 to float, !taffo.info !324, !taffo.initweight !35, !llfi_index !344
  %fi74 = call float @injectFault3(i64 250, float %20, i32 44, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @sitofp_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi77 = call i32 @injectFault1(i64 251, i32 %fi58, i32 44, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @sitofp_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %21 = sitofp i32 %fi77 to float, !llfi_index !345
  %fi76 = call float @injectFault3(i64 251, float %21, i32 44, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @sitofp_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi79 = call float @injectFault3(i64 252, float %fi74, i32 21, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi80 = call float @injectFault3(i64 252, float %fi76, i32 21, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %22 = fdiv float %fi79, %fi80, !taffo.info !324, !taffo.initweight !38, !llfi_index !346
  %fi78 = call float @injectFault3(i64 252, float %22, i32 21, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi82 = call i32 @injectFault1(i64 253, i32 %fi63, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi83 = call i32 @injectFault1(i64 253, i32 %fi43, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %23 = add nsw i32 %fi82, %fi83, !taffo.info !324, !taffo.initweight !35, !llfi_index !347
  %fi81 = call i32 @injectFault1(i64 253, i32 %23, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi85 = call i32 @injectFault1(i64 254, i32 %fi63, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi86 = call i32 @injectFault1(i64 254, i32 %fi68, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %24 = add nsw i32 %fi85, %fi86, !llfi_index !348
  %fi84 = call i32 @injectFault1(i64 254, i32 %24, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi88 = call i32 @injectFault1(i64 255, i32 %fi84, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi89 = call i32 @injectFault1(i64 255, i32 %fi43, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %25 = add nsw i32 %fi88, %fi89, !taffo.info !324, !taffo.initweight !35, !llfi_index !349
  %fi87 = call i32 @injectFault1(i64 255, i32 %25, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi9 = call float @injectFault3(i64 256, float %fi78, i32 56, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @call_namestr, i32 0, i32 0)), !llfi_injectfault !34
  call void @_Z9fftSinCosfPfS_.3_fixp(float %fi9, float* %5, float* %6), !taffo.info !33, !llfi_index !350, !taffo.constinfo !74
  %fi91 = call i32 @injectFault1(i64 257, i32 %fi81, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %26 = sext i32 %fi91 to i64, !llfi_index !351
  %fi90 = call i64 @injectFault2(i64 257, i64 %26, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi92 = call i64 @injectFault2(i64 258, i64 %fi90, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %27 = getelementptr i32, i32* %1, i64 %fi92, !taffo.info !324, !taffo.initweight !35, !llfi_index !352
  %28 = load i32, i32* %27, align 4, !taffo.info !324, !taffo.initweight !38, !llfi_index !353
  %fi93 = call i32 @injectFault1(i64 259, i32 %28, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi95 = call i32 @injectFault1(i64 260, i32 %fi93, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %29 = sext i32 %fi95 to i64, !taffo.info !324, !taffo.initweight !43, !llfi_index !354
  %fi94 = call i64 @injectFault2(i64 260, i64 %29, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %.flt6 = getelementptr inbounds %struct.Complex, %struct.Complex* %2, i64 %fi94, !taffo.initweight !35, !taffo.target !3, !taffo.structinfo !355, !llfi_index !356
  ...
  %fi96 = call i32 @injectFault1(i64 267, i32 %s15_17fixp21, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi98 = call i32 @injectFault1(i64 268, i32 %fi87, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %33 = sext i32 %fi98 to i64, !llfi_index !364
  %fi97 = call i64 @injectFault2(i64 268, i64 %33, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi99 = call i64 @injectFault2(i64 269, i64 %fi97, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %34 = getelementptr i32, i32* %1, i64 %fi99, !taffo.info !324, !taffo.initweight !35, !llfi_index !365
  %35 = load i32, i32* %34, align 4, !taffo.info !324, !taffo.initweight !38, !llfi_index !366
  %fi100 = call i32 @injectFault1(i64 270, i32 %35, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi102 = call i32 @injectFault1(i64 271, i32 %fi100, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %36 = sext i32 %fi102 to i64, !taffo.info !324, !taffo.initweight !43, !llfi_index !367
  %fi101 = call i64 @injectFault2(i64 271, i64 %36, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %.flt2 = getelementptr inbounds %struct.Complex, %struct.Complex* %2, i64 %fi101, !taffo.initweight !35, !taffo.target !3, !taffo.structinfo !355, !llfi_index !368
  ...
  %fi103 = call float @injectFault3(i64 274, float %38, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %39 = load float, float* %6, align 4, !taffo.info !33, !taffo.initweight !358, !llfi_index !371
  %fi104 = call float @injectFault3(i64 275, float %39, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi106 = call i32 @injectFault1(i64 276, i32 %fi81, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %40 = sext i32 %fi106 to i64, !llfi_index !372
  %fi105 = call i64 @injectFault2(i64 276, i64 %40, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi107 = call i64 @injectFault2(i64 277, i64 %fi105, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %41 = getelementptr i32, i32* %1, i64 %fi107, !taffo.info !324, !taffo.initweight !35, !llfi_index !373
  %42 = load i32, i32* %41, align 4, !taffo.info !324, !taffo.initweight !38, !llfi_index !374
  %fi108 = call i32 @injectFault1(i64 278, i32 %42, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi110 = call i32 @injectFault1(i64 279, i32 %fi108, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %43 = sext i32 %fi110 to i64, !taffo.info !324, !taffo.initweight !43, !llfi_index !375
  %fi109 = call i64 @injectFault2(i64 279, i64 %43, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %.flt4 = getelementptr inbounds %struct.Complex, %struct.Complex* %2, i64 %fi109, !taffo.initweight !35, !taffo.target !3, !taffo.structinfo !355, !llfi_index !376
  ...
  %fi111 = call float @injectFault3(i64 282, float %45, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %46 = load float, float* %5, align 4, !taffo.info !33, !taffo.initweight !358, !llfi_index !379
  %fi112 = call float @injectFault3(i64 283, float %46, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi114 = call float @injectFault3(i64 284, float %fi111, i32 18, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi115 = call float @injectFault3(i64 284, float %fi112, i32 18, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %47 = fmul float %fi114, %fi115, !taffo.info !33, !taffo.initweight !35, !llfi_index !380
  %fi113 = call float @injectFault3(i64 284, float %47, i32 18, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi117 = call float @injectFault3(i64 285, float %fi113, i32 12, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fneg_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %48 = fneg float %fi117, !taffo.info !33, !taffo.initweight !38, !llfi_index !381
  %fi116 = call float @injectFault3(i64 285, float %48, i32 12, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fneg_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %49 = call float @llvm.fmuladd.f32(float %fi103, float %fi104, float %fi116), !taffo.info !33, !taffo.initweight !35, !llfi_index !382, !taffo.constinfo !74
  %fi119 = call float @injectFault3(i64 287, float 1.310720e+05, i32 18, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi120 = call float @injectFault3(i64 287, float %49, i32 18, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %50 = fmul float %fi119, %fi120, !taffo.info !33, !llfi_index !383
  %fi118 = call float @injectFault3(i64 287, float %50, i32 18, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi122 = call float @injectFault3(i64 288, float %fi118, i32 42, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fptosi_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %51 = fptosi float %fi122 to i32, !taffo.info !33, !llfi_index !384
  %fi121 = call i32 @injectFault1(i64 288, i32 %51, i32 42, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fptosi_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi124 = call i32 @injectFault1(i64 289, i32 %fi96, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi125 = call i32 @injectFault1(i64 289, i32 %fi121, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %s15_17fixp25 = add i32 %fi124, %fi125, !taffo.info !385, !llfi_index !386
  %fi123 = call i32 @injectFault1(i64 289, i32 %s15_17fixp25, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi127 = call i32 @injectFault1(i64 290, i32 %fi123, i32 44, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @sitofp_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %52 = sitofp i32 %fi127 to float, !taffo.info !385, !llfi_index !387
  %fi126 = call float @injectFault3(i64 290, float %52, i32 44, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @sitofp_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi129 = call float @injectFault3(i64 291, float %fi126, i32 21, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi130 = call float @injectFault3(i64 291, float 1.310720e+05, i32 21, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %53 = fdiv float %fi129, %fi130, !taffo.info !385, !llfi_index !388
  %fi128 = call float @injectFault3(i64 291, float %53, i32 21, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi132 = call i32 @injectFault1(i64 292, i32 %fi81, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %54 = sext i32 %fi132 to i64, !llfi_index !389
  %fi131 = call i64 @injectFault2(i64 292, i64 %54, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi133 = call i64 @injectFault2(i64 293, i64 %fi131, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %55 = getelementptr i32, i32* %1, i64 %fi133, !taffo.info !324, !taffo.initweight !35, !llfi_index !390
  %56 = load i32, i32* %55, align 4, !taffo.info !324, !taffo.initweight !38, !llfi_index !391
  %fi134 = call i32 @injectFault1(i64 294, i32 %56, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi136 = call i32 @injectFault1(i64 295, i32 %fi134, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %57 = sext i32 %fi136 to i64, !taffo.info !324, !taffo.initweight !43, !llfi_index !392
  %fi135 = call i64 @injectFault2(i64 295, i64 %57, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %.flt11 = getelementptr inbounds %struct.Complex, %struct.Complex* %2, i64 %fi135, !taffo.initweight !35, !taffo.target !3, !taffo.structinfo !355, !llfi_index !393
  ...
  %fi137 = call float @injectFault3(i64 298, float %fi128, i32 33, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @store_namestr, i32 0, i32 0)), !llfi_injectfault !34
  store float %fi137, float* %58, align 4, !taffo.info !33, !taffo.target !3, !llfi_index !395
  ...
  %fi1 = call i32 @injectFault1(i64 300, i32 %s15_17fixp20, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi3 = call i32 @injectFault1(i64 301, i32 %fi81, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %59 = sext i32 %fi3 to i64, !llfi_index !398
  %fi2 = call i64 @injectFault2(i64 301, i64 %59, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi142 = call i64 @injectFault2(i64 302, i64 %fi2, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %60 = getelementptr i32, i32* %1, i64 %fi142, !taffo.info !324, !taffo.initweight !35, !llfi_index !399
  %61 = load i32, i32* %60, align 4, !taffo.info !324, !taffo.initweight !38, !llfi_index !400
  %fi143 = call i32 @injectFault1(i64 303, i32 %61, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi145 = call i32 @injectFault1(i64 304, i32 %fi143, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %62 = sext i32 %fi145 to i64, !taffo.info !324, !taffo.initweight !43, !llfi_index !401
  %fi144 = call i64 @injectFault2(i64 304, i64 %62, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %.flt14 = getelementptr inbounds %struct.Complex, %struct.Complex* %2, i64 %fi144, !taffo.initweight !35, !taffo.target !3, !taffo.structinfo !355, !llfi_index !402
  ...
  %fi146 = call float @injectFault3(i64 307, float %64, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %65 = load float, float* %6, align 4, !taffo.info !33, !taffo.initweight !358, !llfi_index !405
  %fi147 = call float @injectFault3(i64 308, float %65, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi149 = call i32 @injectFault1(i64 309, i32 %fi87, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %66 = sext i32 %fi149 to i64, !llfi_index !406
  %fi148 = call i64 @injectFault2(i64 309, i64 %66, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi150 = call i64 @injectFault2(i64 310, i64 %fi148, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %67 = getelementptr i32, i32* %1, i64 %fi150, !taffo.info !324, !taffo.initweight !35, !llfi_index !407
  %68 = load i32, i32* %67, align 4, !taffo.info !324, !taffo.initweight !38, !llfi_index !408
  %fi151 = call i32 @injectFault1(i64 311, i32 %68, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi153 = call i32 @injectFault1(i64 312, i32 %fi151, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %69 = sext i32 %fi153 to i64, !taffo.info !324, !taffo.initweight !43, !llfi_index !409
  %fi152 = call i64 @injectFault2(i64 312, i64 %69, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %.flt3 = getelementptr inbounds %struct.Complex, %struct.Complex* %2, i64 %fi152, !taffo.initweight !35, !taffo.target !3, !taffo.structinfo !355, !llfi_index !410
  ...
  %fi154 = call float @injectFault3(i64 315, float %71, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %72 = load float, float* %5, align 4, !taffo.info !33, !taffo.initweight !358, !llfi_index !413
  %fi155 = call float @injectFault3(i64 316, float %72, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi157 = call float @injectFault3(i64 317, float %fi154, i32 18, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi158 = call float @injectFault3(i64 317, float %fi155, i32 18, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %73 = fmul float %fi157, %fi158, !taffo.info !33, !taffo.initweight !35, !llfi_index !414
  %fi156 = call float @injectFault3(i64 317, float %73, i32 18, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %74 = call float @llvm.fmuladd.f32(float %fi146, float %fi147, float %fi156), !taffo.info !33, !taffo.initweight !35, !llfi_index !415, !taffo.constinfo !74
  %fi160 = call float @injectFault3(i64 319, float 1.310720e+05, i32 18, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi161 = call float @injectFault3(i64 319, float %74, i32 18, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %75 = fmul float %fi160, %fi161, !taffo.info !33, !llfi_index !416
  %fi159 = call float @injectFault3(i64 319, float %75, i32 18, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi163 = call float @injectFault3(i64 320, float %fi159, i32 42, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fptosi_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %76 = fptosi float %fi163 to i32, !taffo.info !33, !llfi_index !417
  %fi162 = call i32 @injectFault1(i64 320, i32 %76, i32 42, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fptosi_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi165 = call i32 @injectFault1(i64 321, i32 %fi1, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi166 = call i32 @injectFault1(i64 321, i32 %fi162, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %s15_17fixp22 = add i32 %fi165, %fi166, !taffo.info !5, !llfi_index !418
  %fi164 = call i32 @injectFault1(i64 321, i32 %s15_17fixp22, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi168 = call i32 @injectFault1(i64 322, i32 %fi164, i32 44, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @sitofp_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %77 = sitofp i32 %fi168 to float, !taffo.info !5, !llfi_index !419
  %fi167 = call float @injectFault3(i64 322, float %77, i32 44, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @sitofp_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi170 = call float @injectFault3(i64 323, float %fi167, i32 21, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi171 = call float @injectFault3(i64 323, float 1.310720e+05, i32 21, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %78 = fdiv float %fi170, %fi171, !taffo.info !5, !llfi_index !420
  %fi169 = call float @injectFault3(i64 323, float %78, i32 21, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi173 = call i32 @injectFault1(i64 324, i32 %fi81, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %79 = sext i32 %fi173 to i64, !llfi_index !421
  %fi172 = call i64 @injectFault2(i64 324, i64 %79, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi174 = call i64 @injectFault2(i64 325, i64 %fi172, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %80 = getelementptr i32, i32* %1, i64 %fi174, !taffo.info !324, !taffo.initweight !35, !llfi_index !422
  %81 = load i32, i32* %80, align 4, !taffo.info !324, !taffo.initweight !38, !llfi_index !423
  %fi175 = call i32 @injectFault1(i64 326, i32 %81, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi177 = call i32 @injectFault1(i64 327, i32 %fi175, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %82 = sext i32 %fi177 to i64, !taffo.info !324, !taffo.initweight !43, !llfi_index !424
  %fi176 = call i64 @injectFault2(i64 327, i64 %82, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %.flt12 = getelementptr inbounds %struct.Complex, %struct.Complex* %2, i64 %fi176, !taffo.initweight !35, !taffo.target !3, !taffo.structinfo !355, !llfi_index !425
  ...
  %fi178 = call float @injectFault3(i64 330, float %fi169, i32 33, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @store_namestr, i32 0, i32 0)), !llfi_injectfault !34
  store float %fi178, float* %83, align 4, !taffo.info !33, !taffo.target !3, !llfi_index !427
  ...
  %fi179 = call i32 @injectFault1(i64 332, i32 %s15_17fixp19, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi181 = call i32 @injectFault1(i64 333, i32 %fi87, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %84 = sext i32 %fi181 to i64, !llfi_index !430
  %fi180 = call i64 @injectFault2(i64 333, i64 %84, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi182 = call i64 @injectFault2(i64 334, i64 %fi180, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %85 = getelementptr i32, i32* %1, i64 %fi182, !taffo.info !324, !taffo.initweight !35, !llfi_index !431
  %86 = load i32, i32* %85, align 4, !taffo.info !324, !taffo.initweight !38, !llfi_index !432
  %fi183 = call i32 @injectFault1(i64 335, i32 %86, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi185 = call i32 @injectFault1(i64 336, i32 %fi183, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %87 = sext i32 %fi185 to i64, !taffo.info !324, !taffo.initweight !43, !llfi_index !433
  %fi184 = call i64 @injectFault2(i64 336, i64 %87, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %.flt10 = getelementptr inbounds %struct.Complex, %struct.Complex* %2, i64 %fi184, !taffo.initweight !35, !taffo.target !3, !taffo.structinfo !355, !llfi_index !434
  ...
  %fi186 = call float @injectFault3(i64 339, float %89, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %90 = load float, float* %6, align 4, !taffo.info !33, !taffo.initweight !358, !llfi_index !437
  %fi138 = call float @injectFault3(i64 340, float %90, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi140 = call i32 @injectFault1(i64 341, i32 %fi81, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %91 = sext i32 %fi140 to i64, !llfi_index !438
  %fi139 = call i64 @injectFault2(i64 341, i64 %91, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi141 = call i64 @injectFault2(i64 342, i64 %fi139, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %92 = getelementptr i32, i32* %1, i64 %fi141, !taffo.info !324, !taffo.initweight !35, !llfi_index !439
  %93 = load i32, i32* %92, align 4, !taffo.info !324, !taffo.initweight !38, !llfi_index !440
  %fi192 = call i32 @injectFault1(i64 343, i32 %93, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi11 = call i32 @injectFault1(i64 344, i32 %fi192, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %94 = sext i32 %fi11 to i64, !taffo.info !324, !taffo.initweight !43, !llfi_index !441
  %fi10 = call i64 @injectFault2(i64 344, i64 %94, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %.flt1 = getelementptr inbounds %struct.Complex, %struct.Complex* %2, i64 %fi10, !taffo.initweight !35, !taffo.target !3, !taffo.structinfo !355, !llfi_index !442
  ...
  %fi187 = call float @injectFault3(i64 347, float %96, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %97 = load float, float* %5, align 4, !taffo.info !33, !taffo.initweight !358, !llfi_index !445
  %fi188 = call float @injectFault3(i64 348, float %97, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi190 = call float @injectFault3(i64 349, float %fi187, i32 18, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi191 = call float @injectFault3(i64 349, float %fi188, i32 18, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %98 = fmul float %fi190, %fi191, !taffo.info !33, !taffo.initweight !35, !llfi_index !446
  %fi189 = call float @injectFault3(i64 349, float %98, i32 18, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi13 = call float @injectFault3(i64 350, float %fi189, i32 12, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fneg_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %99 = fneg float %fi13, !taffo.info !33, !taffo.initweight !38, !llfi_index !447
  %fi12 = call float @injectFault3(i64 350, float %99, i32 12, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fneg_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %100 = call float @llvm.fmuladd.f32(float %fi186, float %fi138, float %fi12), !taffo.info !33, !taffo.initweight !35, !llfi_index !448, !taffo.constinfo !74
  %fi15 = call float @injectFault3(i64 352, float 1.310720e+05, i32 18, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi16 = call float @injectFault3(i64 352, float %100, i32 18, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %101 = fmul float %fi15, %fi16, !taffo.info !33, !llfi_index !449
  %fi14 = call float @injectFault3(i64 352, float %101, i32 18, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi18 = call float @injectFault3(i64 353, float %fi14, i32 42, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fptosi_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %102 = fptosi float %fi18 to i32, !taffo.info !33, !llfi_index !450
  %fi17 = call i32 @injectFault1(i64 353, i32 %102, i32 42, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fptosi_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi20 = call i32 @injectFault1(i64 354, i32 %fi179, i32 15, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi21 = call i32 @injectFault1(i64 354, i32 %fi17, i32 15, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %s15_17fixp24 = sub i32 %fi20, %fi21, !taffo.info !385, !llfi_index !451
  %fi19 = call i32 @injectFault1(i64 354, i32 %s15_17fixp24, i32 15, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi23 = call i32 @injectFault1(i64 355, i32 %fi19, i32 44, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @sitofp_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %103 = sitofp i32 %fi23 to float, !taffo.info !385, !llfi_index !452
  %fi22 = call float @injectFault3(i64 355, float %103, i32 44, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @sitofp_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi25 = call float @injectFault3(i64 356, float %fi22, i32 21, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi26 = call float @injectFault3(i64 356, float 1.310720e+05, i32 21, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %104 = fdiv float %fi25, %fi26, !taffo.info !385, !llfi_index !453
  %fi24 = call float @injectFault3(i64 356, float %104, i32 21, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi28 = call i32 @injectFault1(i64 357, i32 %fi87, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %105 = sext i32 %fi28 to i64, !llfi_index !454
  %fi27 = call i64 @injectFault2(i64 357, i64 %105, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi29 = call i64 @injectFault2(i64 358, i64 %fi27, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %106 = getelementptr i32, i32* %1, i64 %fi29, !taffo.info !324, !taffo.initweight !35, !llfi_index !455
  %107 = load i32, i32* %106, align 4, !taffo.info !324, !taffo.initweight !38, !llfi_index !456
  %fi30 = call i32 @injectFault1(i64 359, i32 %107, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi72 = call i32 @injectFault1(i64 360, i32 %fi30, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %108 = sext i32 %fi72 to i64, !taffo.info !324, !taffo.initweight !43, !llfi_index !457
  %fi71 = call i64 @injectFault2(i64 360, i64 %108, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %.flt5 = getelementptr inbounds %struct.Complex, %struct.Complex* %2, i64 %fi71, !taffo.initweight !35, !taffo.target !3, !taffo.structinfo !355, !llfi_index !458
  ...
  %fi = call float @injectFault3(i64 363, float %fi24, i32 33, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @store_namestr, i32 0, i32 0)), !llfi_injectfault !34
  store float %fi, float* %109, align 4, !taffo.info !33, !taffo.target !3, !llfi_index !460
  ...
  %fi31 = call i32 @injectFault1(i64 365, i32 %s15_17fixp18, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi33 = call i32 @injectFault1(i64 366, i32 %fi81, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %110 = sext i32 %fi33 to i64, !llfi_index !463
  %fi32 = call i64 @injectFault2(i64 366, i64 %110, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi34 = call i64 @injectFault2(i64 367, i64 %fi32, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %111 = getelementptr i32, i32* %1, i64 %fi34, !taffo.info !324, !taffo.initweight !35, !llfi_index !464
  %112 = load i32, i32* %111, align 4, !taffo.info !324, !taffo.initweight !38, !llfi_index !465
  %fi35 = call i32 @injectFault1(i64 368, i32 %112, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi37 = call i32 @injectFault1(i64 369, i32 %fi35, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %113 = sext i32 %fi37 to i64, !taffo.info !324, !taffo.initweight !43, !llfi_index !466
  %fi36 = call i64 @injectFault2(i64 369, i64 %113, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %.flt = getelementptr inbounds %struct.Complex, %struct.Complex* %2, i64 %fi36, !taffo.initweight !35, !taffo.target !3, !taffo.structinfo !355, !llfi_index !467
  ...
  %fi42 = call float @injectFault3(i64 372, float %115, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %116 = load float, float* %6, align 4, !taffo.info !33, !taffo.initweight !358, !llfi_index !470
  %fi4 = call float @injectFault3(i64 373, float %116, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi6 = call i32 @injectFault1(i64 374, i32 %fi87, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %117 = sext i32 %fi6 to i64, !llfi_index !471
  %fi5 = call i64 @injectFault2(i64 374, i64 %117, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi7 = call i64 @injectFault2(i64 375, i64 %fi5, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %118 = getelementptr i32, i32* %1, i64 %fi7, !taffo.info !324, !taffo.initweight !35, !llfi_index !472
  %119 = load i32, i32* %118, align 4, !taffo.info !324, !taffo.initweight !38, !llfi_index !473
  %fi8 = call i32 @injectFault1(i64 376, i32 %119, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi194 = call i32 @injectFault1(i64 377, i32 %fi8, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %120 = sext i32 %fi194 to i64, !taffo.info !324, !taffo.initweight !43, !llfi_index !474
  %fi193 = call i64 @injectFault2(i64 377, i64 %120, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %.flt8 = getelementptr inbounds %struct.Complex, %struct.Complex* %2, i64 %fi193, !taffo.initweight !35, !taffo.target !3, !taffo.structinfo !355, !llfi_index !475
  ...
  %fi195 = call float @injectFault3(i64 380, float %122, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %123 = load float, float* %5, align 4, !taffo.info !33, !taffo.initweight !358, !llfi_index !478
  %fi196 = call float @injectFault3(i64 381, float %123, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi198 = call float @injectFault3(i64 382, float %fi195, i32 18, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi199 = call float @injectFault3(i64 382, float %fi196, i32 18, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %124 = fmul float %fi198, %fi199, !taffo.info !33, !taffo.initweight !35, !llfi_index !479
  %fi197 = call float @injectFault3(i64 382, float %124, i32 18, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %125 = call float @llvm.fmuladd.f32(float %fi42, float %fi4, float %fi197), !taffo.info !33, !taffo.initweight !35, !llfi_index !480, !taffo.constinfo !74
  %fi201 = call float @injectFault3(i64 384, float 1.310720e+05, i32 18, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi202 = call float @injectFault3(i64 384, float %125, i32 18, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %126 = fmul float %fi201, %fi202, !taffo.info !33, !llfi_index !481
  %fi200 = call float @injectFault3(i64 384, float %126, i32 18, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi204 = call float @injectFault3(i64 385, float %fi200, i32 42, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fptosi_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %127 = fptosi float %fi204 to i32, !taffo.info !33, !llfi_index !482
  %fi203 = call i32 @injectFault1(i64 385, i32 %127, i32 42, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fptosi_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi206 = call i32 @injectFault1(i64 386, i32 %fi31, i32 15, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi207 = call i32 @injectFault1(i64 386, i32 %fi203, i32 15, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %s15_17fixp23 = sub i32 %fi206, %fi207, !taffo.info !5, !llfi_index !483
  %fi205 = call i32 @injectFault1(i64 386, i32 %s15_17fixp23, i32 15, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi209 = call i32 @injectFault1(i64 387, i32 %fi205, i32 44, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @sitofp_namestr, i32 0, i32 0)), !llfi_injectfault !34
  ...
  %fi214 = call i32 @injectFault1(i64 389, i32 %fi87, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  ...
  %fi38 = call float @injectFault3(i64 395, float %fi210, i32 33, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @store_namestr, i32 0, i32 0)), !llfi_injectfault !34
  store float %fi38, float* %134, align 4, !taffo.info !33, !taffo.target !3, !llfi_index !492
  br label %135, !llfi_index !493

135:                                              ; preds = %19
  %fi40 = call i32 @injectFault1(i64 397, i32 %fi43, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi41 = call i32 @injectFault1(i64 397, i32 1, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %136 = add nsw i32 %fi40, %fi41, !taffo.info !324, !taffo.initweight !35, !llfi_index !494, !taffo.constinfo !45
  %fi39 = call i32 @injectFault1(i64 397, i32 %136, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !37
...
138:                                              ; preds = %137
  %fi220 = call i32 @injectFault1(i64 400, i32 %fi63, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi221 = call i32 @injectFault1(i64 400, i32 %fi58, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
...
141:                                              ; preds = %140
  %fi223 = call i32 @injectFault1(i64 403, i32 %fi57, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
...
define internal void @_Z23radix2DitCooleyTykeyFftiPiP7ComplexS1_.1_fixp(i32 noundef %0, i32* noundef %1, { i32, i32 }* noundef %".<s15_17fixp,s15_17fixp>", { i32, i32 }* noundef %".<s15_17fixp,s15_17fixp>1") #8 !taffo.initweight !583 !taffo.funinfo !584 !taffo.sourceFunction !585 {
  %fi13 = call i32 @injectFault1(i64 475, i32 1, i32 31, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @alloca_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %s2_30fixp = alloca i32, i32 %fi13, align 4, !taffo.info !586, !llfi_index !589
  %fi14 = call i32 @injectFault1(i64 476, i32 1, i32 31, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @alloca_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %s2_30fixp2 = alloca i32, i32 %fi14, align 4, !taffo.info !586, !llfi_index !590
  %fi15 = call i32 @injectFault1(i64 477, i32 1, i32 31, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @alloca_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %3 = alloca { i32, i32 }, i32 %fi15, align 4, !llfi_index !591
  %fi16 = call i32 @injectFault1(i64 478, i32 %0, i32 56, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @call_namestr, i32 0, i32 0)), !llfi_injectfault !34
  call void @_Z14calcFftIndicesiPi.2(i32 noundef %fi16, i32* noundef %1), !taffo.info !324, !taffo.initweight !35, !llfi_index !592, !taffo.constinfo !256, !taffo.originalCall !327
  %fi3 = call i32 @injectFault1(i64 479, i32 0, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi4 = call i32 @injectFault1(i64 479, i32 1, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %4 = add nsw i32 %fi3, %fi4, !taffo.info !167, !llfi_index !593, !taffo.constinfo !45
  %fi2 = call i32 @injectFault1(i64 479, i32 %4, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi18 = call i32 @injectFault1(i64 480, i32 1, i32 25, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi19 = call i32 @injectFault1(i64 480, i32 %fi2, i32 25, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %5 = shl i32 %fi18, %fi19, !taffo.info !594, !llfi_index !596, !taffo.constinfo !45
  %fi17 = call i32 @injectFault1(i64 480, i32 %5, i32 25, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !37
  br label %6, !llfi_index !597

6:                                                ; preds = %145, %2
  %.04 = phi i32 [ 0, %2 ], [ %fi315, %145 ], !taffo.info !122, !llfi_index !598
  %.03 = phi i32 [ %fi17, %2 ], [ %fi321, %145 ], !taffo.info !599, !llfi_index !601
  %fi21 = call i32 @injectFault1(i64 483, i32 %.03, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi20 = call i32 @injectFault1(i64 482, i32 %.04, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi23 = call i32 @injectFault1(i64 484, i32 %fi21, i32 53, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi24 = call i32 @injectFault1(i64 484, i32 %0, i32 53, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %7 = icmp sle i32 %fi23, %fi24, !taffo.info !122, !llfi_index !602
  %fi22 = call i1 @injectFault4(i64 484, i1 %7, i32 53, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi25 = call i1 @injectFault4(i64 485, i1 %fi22, i32 2, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @br_namestr, i32 0, i32 0)), !llfi_injectfault !34
  br i1 %fi25, label %8, label %149, !llfi_index !603
...
9:                                                ; preds = %142, %8
  ...
  %fi29 = call i32 @injectFault1(i64 487, i32 %.02, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi31 = call i32 @injectFault1(i64 488, i32 %fi29, i32 53, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi32 = call i32 @injectFault1(i64 488, i32 %0, i32 53, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %10 = icmp slt i32 %fi31, %fi32, !taffo.info !122, !llfi_index !608
  %fi30 = call i1 @injectFault4(i64 488, i1 %10, i32 53, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi33 = call i1 @injectFault4(i64 489, i1 %fi30, i32 2, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @br_namestr, i32 0, i32 0)), !llfi_injectfault !34
  br i1 %fi33, label %11, label %144, !llfi_index !609

11:                                               ; preds = %9
  %fi35 = call i32 @injectFault1(i64 490, i32 %fi21, i32 27, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi36 = call i32 @injectFault1(i64 490, i32 1, i32 27, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %12 = ashr i32 %fi35, %fi36, !taffo.info !167, !llfi_index !610, !taffo.constinfo !45
  %fi34 = call i32 @injectFault1(i64 490, i32 %12, i32 27, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !37
  br label %13, !llfi_index !611

13:                                               ; preds = %139, %11
  %.01 = phi i32 [ 0, %11 ], [ %fi309, %139 ], !taffo.info !324, !taffo.initweight !2, !llfi_index !612
  %fi37 = call i32 @injectFault1(i64 492, i32 %.01, i32 55, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @phi_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi39 = call i32 @injectFault1(i64 493, i32 %fi37, i32 53, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi40 = call i32 @injectFault1(i64 493, i32 %fi34, i32 53, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %14 = icmp slt i32 %fi39, %fi40, !taffo.info !107, !taffo.initweight !35, !llfi_index !613
  %fi38 = call i1 @injectFault4(i64 493, i1 %14, i32 53, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @icmp_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi41 = call i1 @injectFault4(i64 494, i1 %fi38, i32 2, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @br_namestr, i32 0, i32 0)), !llfi_injectfault !34
  br i1 %fi41, label %15, label %141, !taffo.info !324, !taffo.initweight !38, !llfi_index !614

15:                                               ; preds = %13
  %fi43 = call i32 @injectFault1(i64 495, i32 %fi37, i32 44, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @sitofp_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %16 = sitofp i32 %fi43 to float, !taffo.info !324, !taffo.initweight !35, !llfi_index !615
  %fi42 = call float @injectFault3(i64 495, float %16, i32 44, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @sitofp_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi45 = call i32 @injectFault1(i64 496, i32 %fi21, i32 44, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @sitofp_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %17 = sitofp i32 %fi45 to float, !taffo.info !594, !llfi_index !616
  %fi44 = call float @injectFault3(i64 496, float %17, i32 44, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @sitofp_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi27 = call float @injectFault3(i64 497, float %fi42, i32 21, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi28 = call float @injectFault3(i64 497, float %fi44, i32 21, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %18 = fdiv float %fi27, %fi28, !taffo.info !617, !taffo.initweight !38, !llfi_index !619
  %fi26 = call float @injectFault3(i64 497, float %18, i32 21, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fdiv_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi47 = call i32 @injectFault1(i64 498, i32 %fi29, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi48 = call i32 @injectFault1(i64 498, i32 %fi37, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %19 = add nsw i32 %fi47, %fi48, !taffo.info !324, !taffo.initweight !35, !llfi_index !620
  %fi46 = call i32 @injectFault1(i64 498, i32 %19, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi50 = call i32 @injectFault1(i64 499, i32 %fi29, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi51 = call i32 @injectFault1(i64 499, i32 %fi34, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %20 = add nsw i32 %fi50, %fi51, !taffo.info !167, !llfi_index !621
  %fi49 = call i32 @injectFault1(i64 499, i32 %20, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi53 = call i32 @injectFault1(i64 500, i32 %fi49, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi54 = call i32 @injectFault1(i64 500, i32 %fi37, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %21 = add nsw i32 %fi53, %fi54, !taffo.info !622, !taffo.initweight !35, !llfi_index !624
  %fi52 = call i32 @injectFault1(i64 500, i32 %21, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi56 = call float @injectFault3(i64 501, float 1.024000e+03, i32 18, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi57 = call float @injectFault3(i64 501, float %fi26, i32 18, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %22 = fmul float %fi56, %fi57, !taffo.info !617, !llfi_index !625
  %fi55 = call float @injectFault3(i64 501, float %22, i32 18, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @fmul_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi59 = call float @injectFault3(i64 502, float %fi55, i32 41, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fptoui_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %23 = fptoui float %fi59 to i32, !taffo.info !617, !llfi_index !626
  %fi58 = call i32 @injectFault1(i64 502, i32 %23, i32 41, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @fptoui_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi60 = call i32 @injectFault1(i64 503, i32 %fi58, i32 56, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @call_namestr, i32 0, i32 0)), !llfi_injectfault !34
  call void @_Z9fftSinCosfPfS_.5_fixp(i32 %fi60, i32* %s2_30fixp, i32* %s2_30fixp2), !taffo.info !33, !llfi_index !627, !taffo.constinfo !74
  %fi62 = call i32 @injectFault1(i64 504, i32 %fi46, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %24 = sext i32 %fi62 to i64, !taffo.info !628, !llfi_index !629
  %fi61 = call i64 @injectFault2(i64 504, i64 %24, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi63 = call i64 @injectFault2(i64 505, i64 %fi61, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %25 = getelementptr i32, i32* %1, i64 %fi63, !taffo.info !324, !taffo.initweight !35, !llfi_index !630
  %26 = load i32, i32* %25, align 4, !taffo.info !107, !taffo.initweight !38, !llfi_index !631
  %fi64 = call i32 @injectFault1(i64 506, i32 %26, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi66 = call i32 @injectFault1(i64 507, i32 %fi64, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %27 = sext i32 %fi66 to i64, !taffo.info !107, !taffo.initweight !43, !llfi_index !632
  %fi65 = call i64 @injectFault2(i64 507, i64 %27, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %28 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %".<s15_17fixp,s15_17fixp>", i64 %fi65, !taffo.target !3, !llfi_index !633
  ...
  %fi67 = call i32 @injectFault1(i64 515, i32 %s15_17fixp29, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi69 = call i32 @injectFault1(i64 516, i32 %fi52, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %33 = sext i32 %fi69 to i64, !taffo.info !643, !llfi_index !644
  %fi68 = call i64 @injectFault2(i64 516, i64 %33, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi70 = call i64 @injectFault2(i64 517, i64 %fi68, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %34 = getelementptr i32, i32* %1, i64 %fi70, !taffo.info !324, !taffo.initweight !35, !llfi_index !645
  %35 = load i32, i32* %34, align 4, !taffo.info !107, !taffo.initweight !38, !llfi_index !646
  %fi71 = call i32 @injectFault1(i64 518, i32 %35, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi1 = call i32 @injectFault1(i64 519, i32 %fi71, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %36 = sext i32 %fi1 to i64, !taffo.info !107, !taffo.initweight !43, !llfi_index !647
  %fi = call i64 @injectFault2(i64 519, i64 %36, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %37 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %".<s15_17fixp,s15_17fixp>", i64 %fi, !taffo.target !3, !llfi_index !648
  ...
  %fi72 = call i32 @injectFault1(i64 522, i32 %s15_17fixp30, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %s2_30fixp10 = load i32, i32* %s2_30fixp2, align 4, !taffo.info !586, !llfi_index !652
  %fi73 = call i32 @injectFault1(i64 523, i32 %s2_30fixp10, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi76 = call i32 @injectFault1(i64 524, i32 %fi46, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %38 = sext i32 %fi76 to i64, !taffo.info !628, !llfi_index !653
  %fi75 = call i64 @injectFault2(i64 524, i64 %38, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi77 = call i64 @injectFault2(i64 525, i64 %fi75, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %39 = getelementptr i32, i32* %1, i64 %fi77, !taffo.info !324, !taffo.initweight !35, !llfi_index !654
  %40 = load i32, i32* %39, align 4, !taffo.info !107, !taffo.initweight !38, !llfi_index !655
  %fi78 = call i32 @injectFault1(i64 526, i32 %40, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi80 = call i32 @injectFault1(i64 527, i32 %fi78, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %41 = sext i32 %fi80 to i64, !taffo.info !107, !taffo.initweight !43, !llfi_index !656
  %fi79 = call i64 @injectFault2(i64 527, i64 %41, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %42 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %".<s15_17fixp,s15_17fixp>", i64 %fi79, !taffo.target !3, !llfi_index !657
  ...
  %fi81 = call i32 @injectFault1(i64 530, i32 %s15_17fixp31, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %s2_30fixp6 = load i32, i32* %s2_30fixp, align 4, !taffo.info !586, !llfi_index !660
  %fi82 = call i32 @injectFault1(i64 531, i32 %s2_30fixp6, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi84 = call i32 @injectFault1(i64 532, i32 %fi81, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %43 = sext i32 %fi84 to i64, !taffo.info !10, !taffo.target !3, !llfi_index !661
  %fi83 = call i64 @injectFault2(i64 532, i64 %43, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi86 = call i32 @injectFault1(i64 533, i32 %fi82, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %44 = sext i32 %fi86 to i64, !taffo.info !586, !llfi_index !662
  %fi85 = call i64 @injectFault2(i64 533, i64 %44, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi88 = call i64 @injectFault2(i64 534, i64 %fi83, i32 17, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi89 = call i64 @injectFault2(i64 534, i64 %fi85, i32 17, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %45 = mul i64 %fi88, %fi89, !taffo.info !663, !llfi_index !665
  %fi87 = call i64 @injectFault2(i64 534, i64 %45, i32 17, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi91 = call i64 @injectFault2(i64 535, i64 %fi87, i32 27, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi92 = call i64 @injectFault2(i64 535, i64 30, i32 27, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %46 = ashr i64 %fi91, %fi92, !taffo.info !663, !llfi_index !666
  %fi90 = call i64 @injectFault2(i64 535, i64 %46, i32 27, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi94 = call i64 @injectFault2(i64 536, i64 %fi90, i32 38, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %s15_17fixp38 = trunc i64 %fi94 to i32, !taffo.info !10, !llfi_index !667
  %fi93 = call i32 @injectFault1(i64 536, i32 %s15_17fixp38, i32 38, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi96 = call i32 @injectFault1(i64 537, i32 %fi93, i32 27, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi97 = call i32 @injectFault1(i64 537, i32 1, i32 27, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %47 = ashr i32 %fi96, %fi97, !taffo.info !10, !llfi_index !668
  %fi95 = call i32 @injectFault1(i64 537, i32 %47, i32 27, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi99 = call i32 @injectFault1(i64 538, i32 0, i32 15, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi100 = call i32 @injectFault1(i64 538, i32 %fi95, i32 15, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %s16_16fixp41 = sub i32 %fi99, %fi100, !taffo.info !650, !llfi_index !669
  %fi98 = call i32 @injectFault1(i64 538, i32 %s16_16fixp41, i32 15, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi102 = call i32 @injectFault1(i64 539, i32 %fi72, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %48 = sext i32 %fi102 to i64, !taffo.info !650, !taffo.target !3, !llfi_index !670
  %fi101 = call i64 @injectFault2(i64 539, i64 %48, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi104 = call i32 @injectFault1(i64 540, i32 %fi73, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %49 = sext i32 %fi104 to i64, !taffo.info !586, !llfi_index !671
  %fi103 = call i64 @injectFault2(i64 540, i64 %49, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi106 = call i64 @injectFault2(i64 541, i64 %fi101, i32 17, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi107 = call i64 @injectFault2(i64 541, i64 %fi103, i32 17, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %50 = mul i64 %fi106, %fi107, !taffo.info !672, !llfi_index !674
  %fi105 = call i64 @injectFault2(i64 541, i64 %50, i32 17, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi109 = call i64 @injectFault2(i64 542, i64 %fi105, i32 27, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi110 = call i64 @injectFault2(i64 542, i64 31, i32 27, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %51 = ashr i64 %fi109, %fi110, !llfi_index !675
  %fi108 = call i64 @injectFault2(i64 542, i64 %51, i32 27, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi112 = call i64 @injectFault2(i64 543, i64 %fi108, i32 38, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %52 = trunc i64 %fi112 to i32, !llfi_index !676
  %fi111 = call i32 @injectFault1(i64 543, i32 %52, i32 38, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi114 = call i32 @injectFault1(i64 544, i32 %fi111, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi115 = call i32 @injectFault1(i64 544, i32 %fi98, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %s16_16fixp45 = add i32 %fi114, %fi115, !taffo.info !677, !llfi_index !678
  %fi113 = call i32 @injectFault1(i64 544, i32 %s16_16fixp45, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi117 = call i32 @injectFault1(i64 545, i32 %fi67, i32 27, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi118 = call i32 @injectFault1(i64 545, i32 1, i32 27, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %53 = ashr i32 %fi117, %fi118, !taffo.info !640, !llfi_index !679
  %fi116 = call i32 @injectFault1(i64 545, i32 %53, i32 27, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi120 = call i32 @injectFault1(i64 546, i32 %fi116, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi121 = call i32 @injectFault1(i64 546, i32 %fi113, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %s16_16fixp49 = add i32 %fi120, %fi121, !taffo.info !680, !llfi_index !682
  %fi119 = call i32 @injectFault1(i64 546, i32 %s16_16fixp49, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi123 = call i32 @injectFault1(i64 547, i32 %fi46, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %54 = sext i32 %fi123 to i64, !taffo.info !628, !llfi_index !683
  %fi122 = call i64 @injectFault2(i64 547, i64 %54, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi124 = call i64 @injectFault2(i64 548, i64 %fi122, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %55 = getelementptr i32, i32* %1, i64 %fi124, !taffo.info !324, !taffo.initweight !35, !llfi_index !684
  %56 = load i32, i32* %55, align 4, !taffo.info !107, !taffo.initweight !38, !llfi_index !685
  %fi125 = call i32 @injectFault1(i64 549, i32 %56, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi127 = call i32 @injectFault1(i64 550, i32 %fi125, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %57 = sext i32 %fi127 to i64, !taffo.info !107, !taffo.initweight !43, !llfi_index !686
  %fi126 = call i64 @injectFault2(i64 550, i64 %57, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %58 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %".<s15_17fixp,s15_17fixp>", i64 %fi126, !taffo.target !3, !llfi_index !687
  %s15_17fixp16 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %58, i32 0, i32 0, !taffo.info !10, !taffo.target !3, !llfi_index !688
  %fi129 = call i32 @injectFault1(i64 553, i32 %fi119, i32 25, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi130 = call i32 @injectFault1(i64 553, i32 1, i32 25, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %59 = shl i32 %fi129, %fi130, !taffo.info !680, !llfi_index !689
  %fi128 = call i32 @injectFault1(i64 553, i32 %59, i32 25, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi131 = call i32 @injectFault1(i64 554, i32 %fi128, i32 33, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @store_namestr, i32 0, i32 0)), !llfi_injectfault !34
  store i32 %fi131, i32* %s15_17fixp16, align 4, !taffo.info !33, !taffo.target !3, !llfi_index !690
  ...
  %fi132 = call i32 @injectFault1(i64 556, i32 %s15_17fixp28, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi134 = call i32 @injectFault1(i64 557, i32 %fi46, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %60 = sext i32 %fi134 to i64, !taffo.info !628, !llfi_index !693
  %fi133 = call i64 @injectFault2(i64 557, i64 %60, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi135 = call i64 @injectFault2(i64 558, i64 %fi133, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %61 = getelementptr i32, i32* %1, i64 %fi135, !taffo.info !324, !taffo.initweight !35, !llfi_index !694
  %62 = load i32, i32* %61, align 4, !taffo.info !107, !taffo.initweight !38, !llfi_index !695
  %fi136 = call i32 @injectFault1(i64 559, i32 %62, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi138 = call i32 @injectFault1(i64 560, i32 %fi136, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %63 = sext i32 %fi138 to i64, !taffo.info !107, !taffo.initweight !43, !llfi_index !696
  %fi137 = call i64 @injectFault2(i64 560, i64 %63, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %64 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %".<s15_17fixp,s15_17fixp>", i64 %fi137, !taffo.target !3, !llfi_index !697
  ...
  %fi139 = call i32 @injectFault1(i64 563, i32 %s15_17fixp32, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %s2_30fixp9 = load i32, i32* %s2_30fixp2, align 4, !taffo.info !586, !llfi_index !700
  %fi74 = call i32 @injectFault1(i64 564, i32 %s2_30fixp9, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi141 = call i32 @injectFault1(i64 565, i32 %fi52, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %65 = sext i32 %fi141 to i64, !taffo.info !643, !llfi_index !701
  %fi140 = call i64 @injectFault2(i64 565, i64 %65, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi142 = call i64 @injectFault2(i64 566, i64 %fi140, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %66 = getelementptr i32, i32* %1, i64 %fi142, !taffo.info !324, !taffo.initweight !35, !llfi_index !702
  %67 = load i32, i32* %66, align 4, !taffo.info !107, !taffo.initweight !38, !llfi_index !703
  %fi143 = call i32 @injectFault1(i64 567, i32 %67, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi145 = call i32 @injectFault1(i64 568, i32 %fi143, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %68 = sext i32 %fi145 to i64, !taffo.info !107, !taffo.initweight !43, !llfi_index !704
  %fi144 = call i64 @injectFault2(i64 568, i64 %68, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %69 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %".<s15_17fixp,s15_17fixp>", i64 %fi144, !taffo.target !3, !llfi_index !705
  ...
  %fi146 = call i32 @injectFault1(i64 571, i32 %s15_17fixp33, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %s2_30fixp5 = load i32, i32* %s2_30fixp, align 4, !taffo.info !586, !llfi_index !708
  %fi147 = call i32 @injectFault1(i64 572, i32 %s2_30fixp5, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi149 = call i32 @injectFault1(i64 573, i32 %fi146, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %70 = sext i32 %fi149 to i64, !taffo.info !10, !taffo.target !3, !llfi_index !709
  %fi148 = call i64 @injectFault2(i64 573, i64 %70, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi151 = call i32 @injectFault1(i64 574, i32 %fi147, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %71 = sext i32 %fi151 to i64, !taffo.info !586, !llfi_index !710
  %fi150 = call i64 @injectFault2(i64 574, i64 %71, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi153 = call i64 @injectFault2(i64 575, i64 %fi148, i32 17, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi154 = call i64 @injectFault2(i64 575, i64 %fi150, i32 17, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %72 = mul i64 %fi153, %fi154, !taffo.info !663, !llfi_index !711
  %fi152 = call i64 @injectFault2(i64 575, i64 %72, i32 17, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi156 = call i64 @injectFault2(i64 576, i64 %fi152, i32 27, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi157 = call i64 @injectFault2(i64 576, i64 31, i32 27, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %73 = ashr i64 %fi156, %fi157, !taffo.info !663, !llfi_index !712
  %fi155 = call i64 @injectFault2(i64 576, i64 %73, i32 27, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi159 = call i64 @injectFault2(i64 577, i64 %fi155, i32 38, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %s16_16fixp = trunc i64 %fi159 to i32, !taffo.info !650, !llfi_index !713
  %fi158 = call i32 @injectFault1(i64 577, i32 %s16_16fixp, i32 38, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi161 = call i32 @injectFault1(i64 578, i32 %fi139, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %74 = sext i32 %fi161 to i64, !taffo.info !650, !taffo.target !3, !llfi_index !714
  %fi160 = call i64 @injectFault2(i64 578, i64 %74, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi163 = call i32 @injectFault1(i64 579, i32 %fi74, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %75 = sext i32 %fi163 to i64, !taffo.info !586, !llfi_index !715
  %fi162 = call i64 @injectFault2(i64 579, i64 %75, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi165 = call i64 @injectFault2(i64 580, i64 %fi160, i32 17, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi166 = call i64 @injectFault2(i64 580, i64 %fi162, i32 17, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %76 = mul i64 %fi165, %fi166, !taffo.info !672, !llfi_index !716
  %fi164 = call i64 @injectFault2(i64 580, i64 %76, i32 17, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi168 = call i64 @injectFault2(i64 581, i64 %fi164, i32 27, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi169 = call i64 @injectFault2(i64 581, i64 31, i32 27, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %77 = ashr i64 %fi168, %fi169, !llfi_index !717
  %fi167 = call i64 @injectFault2(i64 581, i64 %77, i32 27, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi171 = call i64 @injectFault2(i64 582, i64 %fi167, i32 38, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %78 = trunc i64 %fi171 to i32, !llfi_index !718
  %fi170 = call i32 @injectFault1(i64 582, i32 %78, i32 38, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi173 = call i32 @injectFault1(i64 583, i32 %fi170, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi174 = call i32 @injectFault1(i64 583, i32 %fi158, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %s16_16fixp42 = add i32 %fi173, %fi174, !taffo.info !677, !llfi_index !719
  %fi172 = call i32 @injectFault1(i64 583, i32 %s16_16fixp42, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi176 = call i32 @injectFault1(i64 584, i32 %fi132, i32 27, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi177 = call i32 @injectFault1(i64 584, i32 1, i32 27, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %79 = ashr i32 %fi176, %fi177, !taffo.info !640, !llfi_index !720
  %fi175 = call i32 @injectFault1(i64 584, i32 %79, i32 27, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi179 = call i32 @injectFault1(i64 585, i32 %fi175, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi180 = call i32 @injectFault1(i64 585, i32 %fi172, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %s16_16fixp46 = add i32 %fi179, %fi180, !taffo.info !721, !llfi_index !722
  %fi178 = call i32 @injectFault1(i64 585, i32 %s16_16fixp46, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi182 = call i32 @injectFault1(i64 586, i32 %fi46, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %80 = sext i32 %fi182 to i64, !taffo.info !628, !llfi_index !723
  %fi181 = call i64 @injectFault2(i64 586, i64 %80, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi183 = call i64 @injectFault2(i64 587, i64 %fi181, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %81 = getelementptr i32, i32* %1, i64 %fi183, !taffo.info !324, !taffo.initweight !35, !llfi_index !724
  %82 = load i32, i32* %81, align 4, !taffo.info !107, !taffo.initweight !38, !llfi_index !725
  %fi184 = call i32 @injectFault1(i64 588, i32 %82, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi186 = call i32 @injectFault1(i64 589, i32 %fi184, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %83 = sext i32 %fi186 to i64, !taffo.info !107, !taffo.initweight !43, !llfi_index !726
  %fi185 = call i64 @injectFault2(i64 589, i64 %83, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %84 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %".<s15_17fixp,s15_17fixp>", i64 %fi185, !taffo.target !3, !llfi_index !727
  %s15_17fixp19 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %84, i32 0, i32 1, !taffo.info !10, !taffo.target !3, !llfi_index !728
  %fi188 = call i32 @injectFault1(i64 592, i32 %fi178, i32 25, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi189 = call i32 @injectFault1(i64 592, i32 1, i32 25, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %85 = shl i32 %fi188, %fi189, !taffo.info !721, !llfi_index !729
  %fi187 = call i32 @injectFault1(i64 592, i32 %85, i32 25, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi190 = call i32 @injectFault1(i64 593, i32 %fi187, i32 33, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @store_namestr, i32 0, i32 0)), !llfi_injectfault !34
  store i32 %fi190, i32* %s15_17fixp19, align 4, !taffo.info !33, !taffo.target !3, !llfi_index !730
  ...
  %fi191 = call i32 @injectFault1(i64 595, i32 %s15_17fixp27, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi193 = call i32 @injectFault1(i64 596, i32 %fi52, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %86 = sext i32 %fi193 to i64, !taffo.info !643, !llfi_index !733
  %fi192 = call i64 @injectFault2(i64 596, i64 %86, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi194 = call i64 @injectFault2(i64 597, i64 %fi192, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %87 = getelementptr i32, i32* %1, i64 %fi194, !taffo.info !324, !taffo.initweight !35, !llfi_index !734
  %88 = load i32, i32* %87, align 4, !taffo.info !107, !taffo.initweight !38, !llfi_index !735
  %fi195 = call i32 @injectFault1(i64 598, i32 %88, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi197 = call i32 @injectFault1(i64 599, i32 %fi195, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %89 = sext i32 %fi197 to i64, !taffo.info !107, !taffo.initweight !43, !llfi_index !736
  %fi196 = call i64 @injectFault2(i64 599, i64 %89, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %90 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %".<s15_17fixp,s15_17fixp>", i64 %fi196, !taffo.target !3, !llfi_index !737
  ...
  %fi198 = call i32 @injectFault1(i64 602, i32 %s15_17fixp34, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %s2_30fixp8 = load i32, i32* %s2_30fixp2, align 4, !taffo.info !586, !llfi_index !740
  %fi199 = call i32 @injectFault1(i64 603, i32 %s2_30fixp8, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi201 = call i32 @injectFault1(i64 604, i32 %fi46, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %91 = sext i32 %fi201 to i64, !taffo.info !628, !llfi_index !741
  %fi200 = call i64 @injectFault2(i64 604, i64 %91, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi202 = call i64 @injectFault2(i64 605, i64 %fi200, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %92 = getelementptr i32, i32* %1, i64 %fi202, !taffo.info !324, !taffo.initweight !35, !llfi_index !742
  %93 = load i32, i32* %92, align 4, !taffo.info !107, !taffo.initweight !38, !llfi_index !743
  %fi203 = call i32 @injectFault1(i64 606, i32 %93, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi205 = call i32 @injectFault1(i64 607, i32 %fi203, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %94 = sext i32 %fi205 to i64, !taffo.info !107, !taffo.initweight !43, !llfi_index !744
  %fi204 = call i64 @injectFault2(i64 607, i64 %94, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %95 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %".<s15_17fixp,s15_17fixp>", i64 %fi204, !taffo.target !3, !llfi_index !745
  ...
  %fi206 = call i32 @injectFault1(i64 610, i32 %s15_17fixp35, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %s2_30fixp4 = load i32, i32* %s2_30fixp, align 4, !taffo.info !586, !llfi_index !748
  %fi207 = call i32 @injectFault1(i64 611, i32 %s2_30fixp4, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi209 = call i32 @injectFault1(i64 612, i32 %fi206, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %96 = sext i32 %fi209 to i64, !taffo.info !10, !taffo.target !3, !llfi_index !749
  %fi208 = call i64 @injectFault2(i64 612, i64 %96, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi211 = call i32 @injectFault1(i64 613, i32 %fi207, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %97 = sext i32 %fi211 to i64, !taffo.info !586, !llfi_index !750
  %fi210 = call i64 @injectFault2(i64 613, i64 %97, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi213 = call i64 @injectFault2(i64 614, i64 %fi208, i32 17, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi214 = call i64 @injectFault2(i64 614, i64 %fi210, i32 17, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %98 = mul i64 %fi213, %fi214, !taffo.info !663, !llfi_index !751
  %fi212 = call i64 @injectFault2(i64 614, i64 %98, i32 17, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi216 = call i64 @injectFault2(i64 615, i64 %fi212, i32 27, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi217 = call i64 @injectFault2(i64 615, i64 30, i32 27, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %99 = ashr i64 %fi216, %fi217, !taffo.info !663, !llfi_index !752
  %fi215 = call i64 @injectFault2(i64 615, i64 %99, i32 27, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi219 = call i64 @injectFault2(i64 616, i64 %fi215, i32 38, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %s15_17fixp39 = trunc i64 %fi219 to i32, !taffo.info !10, !llfi_index !753
  %fi218 = call i32 @injectFault1(i64 616, i32 %s15_17fixp39, i32 38, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi221 = call i32 @injectFault1(i64 617, i32 %fi218, i32 27, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi222 = call i32 @injectFault1(i64 617, i32 1, i32 27, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %100 = ashr i32 %fi221, %fi222, !taffo.info !10, !llfi_index !754
  %fi220 = call i32 @injectFault1(i64 617, i32 %100, i32 27, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi224 = call i32 @injectFault1(i64 618, i32 0, i32 15, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi225 = call i32 @injectFault1(i64 618, i32 %fi220, i32 15, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %s16_16fixp43 = sub i32 %fi224, %fi225, !taffo.info !650, !llfi_index !755
  %fi223 = call i32 @injectFault1(i64 618, i32 %s16_16fixp43, i32 15, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi227 = call i32 @injectFault1(i64 619, i32 %fi198, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %101 = sext i32 %fi227 to i64, !taffo.info !650, !taffo.target !3, !llfi_index !756
  %fi226 = call i64 @injectFault2(i64 619, i64 %101, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi229 = call i32 @injectFault1(i64 620, i32 %fi199, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %102 = sext i32 %fi229 to i64, !taffo.info !586, !llfi_index !757
  %fi228 = call i64 @injectFault2(i64 620, i64 %102, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi231 = call i64 @injectFault2(i64 621, i64 %fi226, i32 17, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi232 = call i64 @injectFault2(i64 621, i64 %fi228, i32 17, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %103 = mul i64 %fi231, %fi232, !taffo.info !672, !llfi_index !758
  %fi230 = call i64 @injectFault2(i64 621, i64 %103, i32 17, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @mul_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi234 = call i64 @injectFault2(i64 622, i64 %fi230, i32 27, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi235 = call i64 @injectFault2(i64 622, i64 31, i32 27, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %104 = ashr i64 %fi234, %fi235, !llfi_index !759
  %fi233 = call i64 @injectFault2(i64 622, i64 %104, i32 27, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi237 = call i64 @injectFault2(i64 623, i64 %fi233, i32 38, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %105 = trunc i64 %fi237 to i32, !llfi_index !760
  %fi236 = call i32 @injectFault1(i64 623, i32 %105, i32 38, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @trunc_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi239 = call i32 @injectFault1(i64 624, i32 %fi236, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi240 = call i32 @injectFault1(i64 624, i32 %fi223, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %s16_16fixp47 = add i32 %fi239, %fi240, !taffo.info !677, !llfi_index !761
  %fi238 = call i32 @injectFault1(i64 624, i32 %s16_16fixp47, i32 13, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi242 = call i32 @injectFault1(i64 625, i32 %fi191, i32 27, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi243 = call i32 @injectFault1(i64 625, i32 1, i32 27, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %106 = ashr i32 %fi242, %fi243, !taffo.info !640, !llfi_index !762
  %fi241 = call i32 @injectFault1(i64 625, i32 %106, i32 27, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi245 = call i32 @injectFault1(i64 626, i32 %fi241, i32 15, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi246 = call i32 @injectFault1(i64 626, i32 %fi238, i32 15, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %s16_16fixp50 = sub i32 %fi245, %fi246, !taffo.info !680, !llfi_index !763
  %fi244 = call i32 @injectFault1(i64 626, i32 %s16_16fixp50, i32 15, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @sub_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi248 = call i32 @injectFault1(i64 627, i32 %fi52, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %107 = sext i32 %fi248 to i64, !taffo.info !643, !llfi_index !764
  %fi247 = call i64 @injectFault2(i64 627, i64 %107, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi249 = call i64 @injectFault2(i64 628, i64 %fi247, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %108 = getelementptr i32, i32* %1, i64 %fi249, !taffo.info !324, !taffo.initweight !35, !llfi_index !765
  %109 = load i32, i32* %108, align 4, !taffo.info !107, !taffo.initweight !38, !llfi_index !766
  %fi250 = call i32 @injectFault1(i64 629, i32 %109, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi252 = call i32 @injectFault1(i64 630, i32 %fi250, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %110 = sext i32 %fi252 to i64, !taffo.info !107, !taffo.initweight !43, !llfi_index !767
  %fi251 = call i64 @injectFault2(i64 630, i64 %110, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %111 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %".<s15_17fixp,s15_17fixp>", i64 %fi251, !taffo.target !3, !llfi_index !768
  %s15_17fixp22 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %111, i32 0, i32 0, !taffo.info !10, !taffo.target !3, !llfi_index !769
  %fi254 = call i32 @injectFault1(i64 633, i32 %fi244, i32 25, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi255 = call i32 @injectFault1(i64 633, i32 1, i32 25, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %112 = shl i32 %fi254, %fi255, !taffo.info !680, !llfi_index !770
  %fi253 = call i32 @injectFault1(i64 633, i32 %112, i32 25, i32 0, i32 3, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @shl_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi256 = call i32 @injectFault1(i64 634, i32 %fi253, i32 33, i32 0, i32 1, i32 1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @store_namestr, i32 0, i32 0)), !llfi_injectfault !34
  store i32 %fi256, i32* %s15_17fixp22, align 4, !taffo.info !33, !taffo.target !3, !llfi_index !771
  ...
  %fi6 = call i32 @injectFault1(i64 636, i32 %s15_17fixp26, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi8 = call i32 @injectFault1(i64 637, i32 %fi46, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %113 = sext i32 %fi8 to i64, !taffo.info !628, !llfi_index !774
  %fi7 = call i64 @injectFault2(i64 637, i64 %113, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi9 = call i64 @injectFault2(i64 638, i64 %fi7, i32 34, i32 0, i32 1, i32 2, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @getelementptr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %114 = getelementptr i32, i32* %1, i64 %fi9, !taffo.info !324, !taffo.initweight !35, !llfi_index !775
  %115 = load i32, i32* %114, align 4, !taffo.info !107, !taffo.initweight !38, !llfi_index !776
  %fi10 = call i32 @injectFault1(i64 639, i32 %115, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %fi12 = call i32 @injectFault1(i64 640, i32 %fi10, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %116 = sext i32 %fi12 to i64, !taffo.info !107, !taffo.initweight !43, !llfi_index !777
  %fi11 = call i64 @injectFault2(i64 640, i64 %116, i32 40, i32 0, i32 2, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !37
  %117 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %".<s15_17fixp,s15_17fixp>", i64 %fi11, !taffo.target !3, !llfi_index !778
  ...
  %fi5 = call i32 @injectFault1(i64 643, i32 %s15_17fixp36, i32 32, i32 0, i32 1, i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @load_namestr, i32 0, i32 0)), !llfi_injectfault !37
  ...
  %fi259 = call i32 @injectFault1(i64 645, i32 %fi52, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  ...
  %fi279 = call i32 @injectFault1(i64 658, i32 %fi5, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
  ...
  %fi294 = call i32 @injectFault1(i64 664, i32 %fi6, i32 27, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @ashr_namestr, i32 0, i32 0)), !llfi_injectfault !34
  ...
  %fi300 = call i32 @injectFault1(i64 666, i32 %fi52, i32 40, i32 1, i32 2, i32 1, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @sext_namestr, i32 0, i32 0)), !llfi_injectfault !34
...
139:                                              ; preds = %15
  %fi310 = call i32 @injectFault1(i64 675, i32 %fi37, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
...
142:                                              ; preds = %141
  %fi313 = call i32 @injectFault1(i64 678, i32 %fi29, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
  %fi314 = call i32 @injectFault1(i64 678, i32 %fi21, i32 13, i32 2, i32 3, i32 2, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
...
145:                                              ; preds = %144
  %fi316 = call i32 @injectFault1(i64 681, i32 %fi20, i32 13, i32 1, i32 3, i32 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @add_namestr, i32 0, i32 0)), !llfi_injectfault !34
